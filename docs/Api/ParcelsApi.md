...
# **apiV1ParcelsGet**
> \Swagger\Client\Boxnow\InlineResponse2009 apiV1ParcelsGet($q, $limit, $order_number, $parcel_id, $payment_state, $payment_mode, $state, $created_from, $created_to, $page_token)
...
$apiInstance = new Swagger\Client\BoxnowAPI\ParcelsApi(
...
$payment_state = new \Swagger\Client\Boxnow\PaymentState(); // \Swagger\Client\Boxnow\PaymentState | 
$payment_mode = new \Swagger\Client\Boxnow\PaymentMode(); // \Swagger\Client\Boxnow\PaymentMode | 
$state = array(new \Swagger\Client\Boxnow\ParcelState()); // \Swagger\Client\Boxnow\ParcelState[] | 
 ...
 **payment_state** | [**\Swagger\Client\Boxnow\PaymentState**](../Model/.md)|  | [optional]
 **payment_mode** | [**\Swagger\Client\Boxnow\PaymentMode**](../Model/.md)|  | [optional]
 **state** | [**\Swagger\Client\Boxnow\ParcelState[]**](../Model/\Swagger\Client\Boxnow\ParcelState.md)|  | [optional]
...
[**\Swagger\Client\Boxnow\InlineResponse2009**](../Model/InlineResponse2009.md)
...
# **uiV1ParcelsCsvGet**
> string uiV1ParcelsCsvGet($q, $order_number, $parcel_id, $payment_state, $payment_mode, $state, $created_from, $created_to)
