...
class ApiV1DeliveryRequestsCustomerReturnsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'sender' => '\Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestDestinationAllOf',
        'destination' => '\Boxnow\API\ApiV1DeliveryRequestsCustomerReturnsPostRequestDestination',
        'parcels' => '\Boxnow\API\ApiV1DeliveryRequestsCustomerReturnsPostRequestParcelsInner[]'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestDestinationAllOf
     */
     ...
     * Sets sender
     *
     * @param \Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestDestinationAllOf $sender sender
     *
     * @return self
     */
     ...
     * Gets destination
     *
     * @return \Boxnow\API\ApiV1DeliveryRequestsCustomerReturnsPostRequestDestination
     */
     ...
     * Sets destination
     *
     * @param \Boxnow\API\ApiV1DeliveryRequestsCustomerReturnsPostRequestDestination $destination destination
     *
     * @return self
     */
     ...
     * Gets parcels
     *
     * @return \Boxnow\API\ApiV1DeliveryRequestsCustomerReturnsPostRequestParcelsInner[]|null
     */
     ...
     * Sets parcels
     *
     * @param \Boxnow\API\ApiV1DeliveryRequestsCustomerReturnsPostRequestParcelsInner[]|null $parcels Use to give us more info about the parcels. If not defined, one parcel is automatically created.
     *
     * @return self
     */
