...
/**
 * ApiV1DeliveryRequestsCustomerReturnsPostRequestDestination Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DeliveryRequestsCustomerReturnsPostRequestDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_delivery_requests_customerReturns_post_request_destination';
    ...
    */
     ...
     * Sets location_id
     *
     * @param string $location_id Location ID of your warehouse from `/destinations` endpoint. Destination where you would like to parcel to be returned.
     *
     * @return self
     */
