...
class ApiV1DeliveryRequestsFromCsvPost200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'destination' => '\Boxnow\API\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerDestination',
        'parcels' => '\Boxnow\API\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerParcelsInner[]'
    ];
    ...
    */
     ...
     * Gets destination
     *
     * @return \Boxnow\API\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerDestination|null
     */
     ...
     * Sets destination
     *
     * @param \Boxnow\API\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerDestination|null $destination destination
     *
     * @return self
     */
     ...
     * Gets parcels
     *
     * @return \Boxnow\API\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerParcelsInner[]
     */
     ...
     * Sets parcels
     *
     * @param \Boxnow\API\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerParcelsInner[] $parcels parcels
     *
     * @return self
     */
