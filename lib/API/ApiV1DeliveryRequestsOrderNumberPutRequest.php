...
/**
 * ApiV1DeliveryRequestsOrderNumberPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DeliveryRequestsOrderNumberPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_delivery_requests__orderNumber__put_request';
    ...
    */
     ...
     * Sets allow_return
     *
     * @param bool|null $allow_return Send true if you want the client to be able to return the order. False if you don't want to allow it.
     *
     * @return self
     */
