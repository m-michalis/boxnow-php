...
class ApiV1DeliveryRequestsPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'parcels' => '\Boxnow\API\ApiV1DeliveryRequestsPost200ResponseParcelsInner[]'
    ];
    ...
    */
     ...
     * Gets parcels
     *
     * @return \Boxnow\API\ApiV1DeliveryRequestsPost200ResponseParcelsInner[]
     */
     ...
     * Sets parcels
     *
     * @param \Boxnow\API\ApiV1DeliveryRequestsPost200ResponseParcelsInner[] $parcels parcels
     *
     * @return self
     */
