...
/**
 * ApiV1DeliveryRequestsPost200ResponseParcelsInner Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DeliveryRequestsPost200ResponseParcelsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_delivery_requests_post_200_response_parcels_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique parcel ID in our system
     *
     * @return self
     */
