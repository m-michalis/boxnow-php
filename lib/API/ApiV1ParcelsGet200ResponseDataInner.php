...
class ApiV1ParcelsGet200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'item_ref_id' => 'string',
        'allow_return' => 'bool',
        'delivery_request' => '\Boxnow\API\DeliveryRequest',
        'events' => '\Boxnow\API\EventsInner[]',
        'parcel_label_url' => 'string',
        'order_label_url' => 'string',
        'cancelation_requested' => 'bool',
        'payment' => '\Boxnow\API\DeliveryPayment',
    ...
    */
     ...
     * Sets state
     *
     * @param \Boxnow\API\ParcelState $state state
     *
     * @return self
     */
     ...
     *
     * @return \Boxnow\API\DeliveryRequest
     */
     ...
     *
     * @param \Boxnow\API\DeliveryRequest $delivery_request delivery_request
     *
     * @return self
     */
     ...
     * Gets events
     *
     * @return \Boxnow\API\EventsInner[]|null
     */
     ...
     * Sets events
     *
     * @param \Boxnow\API\EventsInner[]|null $events events
     *
     * @return self
     */
     ...
     * Gets payment
     *
     * @return \Boxnow\API\DeliveryPayment|null
     */
     ...
     * Sets payment
     *
     * @param \Boxnow\API\DeliveryPayment|null $payment payment
     *
     * @return self
     */
