...
class ApiV1SimpleDeliveryRequestsPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'order_number' => 'string',
        'labels' => '\Boxnow\API\LabelsInner[]',
        'parcels' => '\Boxnow\API\ApiV1SimpleDeliveryRequestsPost200ResponseParcelsInner[]'
    ];
    ...
    */
     ...
     * Sets labels
     *
     * @param \Boxnow\API\LabelsInner[] $labels labels
     *
     * @return self
     */
     ...
     * Gets parcels
     *
     * @return \Boxnow\API\ApiV1SimpleDeliveryRequestsPost200ResponseParcelsInner[]
     */
     ...
     * Sets parcels
     *
     * @param \Boxnow\API\ApiV1SimpleDeliveryRequestsPost200ResponseParcelsInner[] $parcels parcels
     *
     * @return self
     */
