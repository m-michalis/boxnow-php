...
class ApiV1SimpleDeliveryRequestsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'origin' => '\Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestOrigin',
        'destination' => '\Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestDestination',
        'payment_mode' => '\Boxnow\API\PaymentMode',
        'amount_to_be_collected' => 'string',
        'allow_return' => 'bool',
        'parcel_size' => 'float',
        'parcels' => '\Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestParcelsInner[]'
    ];
    ...
    */
     ...
     * Gets origin
     *
     * @return \Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestOrigin
     */
     ...
     * Sets origin
     *
     * @param \Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestOrigin $origin origin
     *
     * @return self
     */
     ...
     * Gets destination
     *
     * @return \Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestDestination
     */
     ...
     * Sets destination
     *
     * @param \Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestDestination $destination destination
     *
     * @return self
     */
     ...
     * Gets payment_mode
     *
     * @return \Boxnow\API\PaymentMode|null
     */
     ...
     * Sets payment_mode
     *
     * @param \Boxnow\API\PaymentMode|null $payment_mode payment_mode
     *
     * @return self
     */
     ...
     * Gets parcels
     *
     * @return \Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestParcelsInner[]|null
     */
     ...
     * Sets parcels
     *
     * @param \Boxnow\API\ApiV1SimpleDeliveryRequestsPostRequestParcelsInner[]|null $parcels Use to give us more info about the parcels. If not defined, one parcel is automatically created.
     *
     * @return self
     */
