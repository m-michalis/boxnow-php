...
class DeliveryPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'mode' => '\Boxnow\API\PaymentMode',
        'price' => '\Boxnow\API\Money',
        'state' => '\Boxnow\API\PaymentState'
    ];
    ...
    */
     ...
     * Sets mode
     *
     * @param \Boxnow\API\PaymentMode $mode mode
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param \Boxnow\API\Money $price price
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Boxnow\API\PaymentState
     */
     ...
     * Sets state
     *
     * @param \Boxnow\API\PaymentState $state state
     *
     * @return self
     */
