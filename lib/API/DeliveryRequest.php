...
class DeliveryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'overwrite_sender_shipping_label_info' => '\Boxnow\API\DeliveryRequestOverwriteSenderShippingLabelInfo',
        'type_of_service' => 'string',
        'description' => 'string',
        'order_number' => 'string',
        'invoice_value' => 'string',
        'payment_mode' => '\Boxnow\API\PaymentMode',
        'amount_to_be_collected' => 'string',
        'allow_return' => 'bool',
        'notify_on_accepted' => 'string',
        'notify_smson_accepted' => 'string',
        'return_location' => '\Boxnow\API\DeliveryRequestReturnLocation',
        'origin' => '\Boxnow\API\DeliveryRequestOrigin',
        'destination' => '\Boxnow\API\DeliveryRequestDestination',
        'items' => '\Boxnow\API\DeliveryRequestItemsInner[]'
    ];
    ...
    */
     ...
     *
     * @return \Boxnow\API\DeliveryRequestOverwriteSenderShippingLabelInfo|null
     */
     ...
     *
     * @param \Boxnow\API\DeliveryRequestOverwriteSenderShippingLabelInfo|null $overwrite_sender_shipping_label_info overwrite_sender_shipping_label_info
     *
     * @return self
     */
     ...
     * Sets payment_mode
     *
     * @param \Boxnow\API\PaymentMode $payment_mode payment_mode
     *
     * @return self
     */
     ...
     *
     * @return \Boxnow\API\DeliveryRequestReturnLocation|null
     */
     ...
     *
     * @param \Boxnow\API\DeliveryRequestReturnLocation|null $return_location return_location
     *
     * @return self
     */
     ...
     * Gets origin
     *
     * @return \Boxnow\API\DeliveryRequestOrigin
     */
     ...
     * Sets origin
     *
     * @param \Boxnow\API\DeliveryRequestOrigin $origin origin
     *
     * @return self
     */
     ...
     * Gets destination
     *
     * @return \Boxnow\API\DeliveryRequestDestination
     */
     ...
     * Sets destination
     *
     * @param \Boxnow\API\DeliveryRequestDestination $destination destination
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \Boxnow\API\DeliveryRequestItemsInner[]
     */
     ...
     * Sets items
     *
     * @param \Boxnow\API\DeliveryRequestItemsInner[] $items List of parcels you want to send via BoxNow.
     *
     * @return self
     */
