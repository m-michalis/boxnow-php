...
/**
 * DeliveryRequestOverwriteSenderShippingLabelInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class DeliveryRequestOverwriteSenderShippingLabelInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryRequest_overwriteSenderShippingLabelInfo';
    ...
    {
        $this->setIfExists('row1', $data ?? [], null);
        $this->setIfExists('row2', $data ?? [], null);
        $this->setIfExists('row3', $data ?? [], null);
        $this->setIfExists('row4', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['row1'];
    }

    /**
     * Sets row1
     *
     * @param string|null $row1 row1
     *
     * @return self
     */
    ...
    {
        if (is_null($row1)) {
            throw new \InvalidArgumentException('non-nullable row1 cannot be null');
        }
        $this->container['row1'] = $row1;
    ...
    {
        return $this->container['row2'];
    }

    /**
     * Sets row2
     *
     * @param string|null $row2 row2
     *
     * @return self
     */
    ...
    {
        if (is_null($row2)) {
            throw new \InvalidArgumentException('non-nullable row2 cannot be null');
        }
        $this->container['row2'] = $row2;
    ...
    {
        return $this->container['row3'];
    }

    /**
     * Sets row3
     *
     * @param string|null $row3 row3
     *
     * @return self
     */
    ...
    {
        if (is_null($row3)) {
            throw new \InvalidArgumentException('non-nullable row3 cannot be null');
        }
        $this->container['row3'] = $row3;
    ...
    {
        return $this->container['row4'];
    }

    /**
     * Sets row4
     *
     * @param string|null $row4 row4
     *
     * @return self
     */
    ...
    {
        if (is_null($row4)) {
            throw new \InvalidArgumentException('non-nullable row4 cannot be null');
        }
        $this->container['row4'] = $row4;
