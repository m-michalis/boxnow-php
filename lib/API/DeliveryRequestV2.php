...
class DeliveryRequestV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'origin' => '\Boxnow\API\DeliveryRequestV2Origin',
        'destination' => '\Boxnow\API\DeliveryRequestV2Destination',
        'parcels' => '\Boxnow\API\DeliveryRequestV2ParcelsInner[]'
    ];
    ...
    */
     ...
     * Gets origin
     *
     * @return \Boxnow\API\DeliveryRequestV2Origin
     */
     ...
     * Sets origin
     *
     * @param \Boxnow\API\DeliveryRequestV2Origin $origin origin
     *
     * @return self
     */
     ...
     * Gets destination
     *
     * @return \Boxnow\API\DeliveryRequestV2Destination
     */
     ...
     * Sets destination
     *
     * @param \Boxnow\API\DeliveryRequestV2Destination $destination destination
     *
     * @return self
     */
     ...
     * Gets parcels
     *
     * @return \Boxnow\API\DeliveryRequestV2ParcelsInner[]
     */
     ...
     * Sets parcels
     *
     * @param \Boxnow\API\DeliveryRequestV2ParcelsInner[] $parcels List of parcels you want to send via BoxNow.
     *
     * @return self
     */
