...
/**
 * DeliveryRequestV2Origin Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryRequestV2Origin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryRequestV2_origin';
    ...
    */
     ...
     * Sets contact_number
     *
     * @param string|null $contact_number Phone number
     *
     * @return self
     */
     ...
     * Sets contact_email
     *
     * @param string|null $contact_email E-mail address
     *
     * @return self
     */
     ...
     * Sets contact_name
     *
     * @param string|null $contact_name Name, e.g. person or company name
     *
     * @return self
     */
     ...
     *
     * @param string|null $delivery_partner_id Use if want to pickup the parcels via another delivery service. ID of Delivery partner, see `/delivery-partners`
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Location ID from `/origins` endpoint
     *
     * @return self
     */
