...
class ParcelLabelData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'parcel' => '\Boxnow\API\ParcelLabelDataParcel',
        'partner_name' => 'string',
        'depot_display_name' => 'string',
        'lane_display_name' => 'string',
        'sender' => '\Boxnow\API\ParcelLabelDataSender',
        'recipient' => '\Boxnow\API\ParcelLabelDataRecipient',
        'delivery' => '\Boxnow\API\ParcelLabelDataDelivery',
        'payment' => '\Boxnow\API\ParcelLabelDataPayment',
        'create_time' => 'string',
        'order_number' => 'string'
    ];
    ...
    */
     ...
     * Gets parcel
     *
     * @return \Boxnow\API\ParcelLabelDataParcel
     */
     ...
     * Sets parcel
     *
     * @param \Boxnow\API\ParcelLabelDataParcel $parcel parcel
     *
     * @return self
     */
     ...
     * Gets sender
     *
     * @return \Boxnow\API\ParcelLabelDataSender
     */
     ...
     * Sets sender
     *
     * @param \Boxnow\API\ParcelLabelDataSender $sender sender
     *
     * @return self
     */
     ...
     * Gets recipient
     *
     * @return \Boxnow\API\ParcelLabelDataRecipient
     */
     ...
     * Sets recipient
     *
     * @param \Boxnow\API\ParcelLabelDataRecipient $recipient recipient
     *
     * @return self
     */
     ...
     * Gets delivery
     *
     * @return \Boxnow\API\ParcelLabelDataDelivery
     */
     ...
     * Sets delivery
     *
     * @param \Boxnow\API\ParcelLabelDataDelivery $delivery delivery
     *
     * @return self
     */
     ...
     * Gets payment
     *
     * @return \Boxnow\API\ParcelLabelDataPayment
     */
     ...
     * Sets payment
     *
     * @param \Boxnow\API\ParcelLabelDataPayment $payment payment
     *
     * @return self
     */
