...
class AuthenticationApi
{
    ...
    /**
     * Operation apiV1AuthSessionsPost
     *
     * Obtain authentication tokens
     *
     * @param  \Boxnow\Model\ApiV1AuthSessionsPostRequest|null $api_v1_auth_sessions_post_request api_v1_auth_sessions_post_request (optional)
     ...
     * @return \Boxnow\Model\ApiV1AuthSessionsPost200Response|\Boxnow\Model\ApiV1AuthSessionsPost400Response|\Boxnow\Model\ApiV1AuthSessionsPost403Response
     */
    ...
    {
        list($response) = $this->apiV1AuthSessionsPostWithHttpInfo($api_v1_auth_sessions_post_request, $contentType);
        return $response;
    }

    /**
     * Operation apiV1AuthSessionsPostWithHttpInfo
     *
     * Obtain authentication tokens
     *
     * @param  \Boxnow\Model\ApiV1AuthSessionsPostRequest|null $api_v1_auth_sessions_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1AuthSessionsPost'] to see the possible values for this operation
     *
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Boxnow\Model\ApiV1AuthSessionsPost200Response|\Boxnow\Model\ApiV1AuthSessionsPost400Response|\Boxnow\Model\ApiV1AuthSessionsPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1AuthSessionsPostWithHttpInfo($api_v1_auth_sessions_post_request = null, string $contentType = self::contentTypes['apiV1AuthSessionsPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Boxnow\Model\ApiV1AuthSessionsPost200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Boxnow\Model\ApiV1AuthSessionsPost200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Boxnow\Model\ApiV1AuthSessionsPost200Response', []),
            ...
            $returnType = '\Boxnow\Model\ApiV1AuthSessionsPost200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Boxnow\Model\ApiV1AuthSessionsPost200Response',
    ...
    /**
     * Operation apiV1AuthSessionsPostAsync
     *
     * Obtain authentication tokens
     *
     * @param  \Boxnow\Model\ApiV1AuthSessionsPostRequest|null $api_v1_auth_sessions_post_request (optional)
     ...
     */
    public function apiV1AuthSessionsPostAsync($api_v1_auth_sessions_post_request = null, string $contentType = self::contentTypes['apiV1AuthSessionsPost'][0])
    {
        return $this->apiV1AuthSessionsPostAsyncWithHttpInfo($api_v1_auth_sessions_post_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiV1AuthSessionsPostAsyncWithHttpInfo
     *
     * Obtain authentication tokens
     *
     * @param  \Boxnow\Model\ApiV1AuthSessionsPostRequest|null $api_v1_auth_sessions_post_request (optional)
     ...
     */
    public function apiV1AuthSessionsPostRequest($api_v1_auth_sessions_post_request = null, string $contentType = self::contentTypes['apiV1AuthSessionsPost'][0])
    {
        ...
        // for model (json/xml)
        if (isset($api_v1_auth_sessions_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($api_v1_auth_sessions_post_request));
            } else {
                $httpBody = $api_v1_auth_sessions_post_request;
            }
