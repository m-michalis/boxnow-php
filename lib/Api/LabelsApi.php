...
class LabelsApi
{
     ...
     * @return \Boxnow\Model\ApiV1DeliveryRequestsOrderNumberLabelGet200Response|\Boxnow\Model\ApiV1AuthSessionsPost400Response|\Boxnow\Model\ApiV1AuthSessionsPost403Response
     */
     ...
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Boxnow\Model\ApiV1DeliveryRequestsOrderNumberLabelGet200Response|\Boxnow\Model\ApiV1AuthSessionsPost400Response|\Boxnow\Model\ApiV1AuthSessionsPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1DeliveryRequestsOrderNumberLabelGetWithHttpInfo($order_number, string $contentType = self::contentTypes['apiV1DeliveryRequestsOrderNumberLabelGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Boxnow\Model\ApiV1DeliveryRequestsOrderNumberLabelGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Boxnow\Model\ApiV1DeliveryRequestsOrderNumberLabelGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Boxnow\Model\ApiV1DeliveryRequestsOrderNumberLabelGet200Response', []),
            ...
            $returnType = '\Boxnow\Model\ApiV1DeliveryRequestsOrderNumberLabelGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Boxnow\Model\ApiV1DeliveryRequestsOrderNumberLabelGet200Response',
     ...
     * @param  float|null $dpi Only applies to ZPL. 200 or 300 supported. (optional, default to 200)
     * @param  float|null $width Label width in mm. Only applies to ZPL. (optional)
     * @param  string|null $printer_model printer_model (optional)
     ...
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SplFileObject|\Boxnow\Model\ApiV1AuthSessionsPost403Response
     */
    public function apiV1DeliveryRequestsOrderNumberLabelTypeGet($order_number, $type, $dpi = 200, $width = null, $printer_model = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1DeliveryRequestsOrderNumberLabelTypeGet'][0])
    {
        list($response) = $this->apiV1DeliveryRequestsOrderNumberLabelTypeGetWithHttpInfo($order_number, $type, $dpi, $width, $printer_model, $x_partner_id, $contentType);
        return $response;
    }
     ...
     * @param  float|null $dpi Only applies to ZPL. 200 or 300 supported. (optional, default to 200)
     * @param  float|null $width Label width in mm. Only applies to ZPL. (optional)
     * @param  string|null $printer_model (optional)
     * @param  string|null $x_partner_id Partner ID you want to manage. You can list partners you are allowed to manage from /entrusted-partners endpoint. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1DeliveryRequestsOrderNumberLabelTypeGet'] to see the possible values for this operation
     *
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SplFileObject|\Boxnow\Model\ApiV1AuthSessionsPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1DeliveryRequestsOrderNumberLabelTypeGetWithHttpInfo($order_number, $type, $dpi = 200, $width = null, $printer_model = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1DeliveryRequestsOrderNumberLabelTypeGet'][0])
    {
        $request = $this->apiV1DeliveryRequestsOrderNumberLabelTypeGetRequest($order_number, $type, $dpi, $width, $printer_model, $x_partner_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1DeliveryRequestsOrderNumberLabelTypeGetAsync($order_number, $type, $dpi = 200, $width = null, $printer_model = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1DeliveryRequestsOrderNumberLabelTypeGet'][0])
    {
        return $this->apiV1DeliveryRequestsOrderNumberLabelTypeGetAsyncWithHttpInfo($order_number, $type, $dpi, $width, $printer_model, $x_partner_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1DeliveryRequestsOrderNumberLabelTypeGetAsyncWithHttpInfo($order_number, $type, $dpi = 200, $width = null, $printer_model = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1DeliveryRequestsOrderNumberLabelTypeGet'][0])
    {
        $returnType = '\SplFileObject';
        $request = $this->apiV1DeliveryRequestsOrderNumberLabelTypeGetRequest($order_number, $type, $dpi, $width, $printer_model, $x_partner_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiV1DeliveryRequestsOrderNumberLabelTypeGetRequest($order_number, $type, $dpi = 200, $width = null, $printer_model = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1DeliveryRequestsOrderNumberLabelTypeGet'][0])
    {
     ...
     *
     * @param  string|null $x_partner_id Partner ID you want to manage. You can list partners you are allowed to manage from /entrusted-partners endpoint. (optional)
     * @param  \Boxnow\Model\ApiV1LabelsSearchPostRequest|null $api_v1_labels_search_post_request api_v1_labels_search_post_request (optional)
     ...
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed|\Boxnow\Model\ApiV1LabelsSearchPost400Response|\Boxnow\Model\ApiV1LabelsSearchPost403Response
     */
    public function apiV1LabelsSearchPost($x_partner_id = null, $api_v1_labels_search_post_request = null, string $contentType = self::contentTypes['apiV1LabelsSearchPost'][0])
    {
        list($response) = $this->apiV1LabelsSearchPostWithHttpInfo($x_partner_id, $api_v1_labels_search_post_request, $contentType);
        return $response;
    }
     ...
     *
     * @param  string|null $x_partner_id Partner ID you want to manage. You can list partners you are allowed to manage from /entrusted-partners endpoint. (optional)
     * @param  \Boxnow\Model\ApiV1LabelsSearchPostRequest|null $api_v1_labels_search_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1LabelsSearchPost'] to see the possible values for this operation
     *
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of mixed|\Boxnow\Model\ApiV1LabelsSearchPost400Response|\Boxnow\Model\ApiV1LabelsSearchPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1LabelsSearchPostWithHttpInfo($x_partner_id = null, $api_v1_labels_search_post_request = null, string $contentType = self::contentTypes['apiV1LabelsSearchPost'][0])
    {
        $request = $this->apiV1LabelsSearchPostRequest($x_partner_id, $api_v1_labels_search_post_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\Boxnow\Model\ApiV1LabelsSearchPost400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Boxnow\Model\ApiV1LabelsSearchPost400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Boxnow\Model\ApiV1LabelsSearchPost400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
                    if ('\Boxnow\Model\ApiV1LabelsSearchPost403Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Boxnow\Model\ApiV1LabelsSearchPost403Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Boxnow\Model\ApiV1LabelsSearchPost403Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Boxnow\Model\ApiV1LabelsSearchPost400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Boxnow\Model\ApiV1LabelsSearchPost403Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1LabelsSearchPostAsync($x_partner_id = null, $api_v1_labels_search_post_request = null, string $contentType = self::contentTypes['apiV1LabelsSearchPost'][0])
    {
        return $this->apiV1LabelsSearchPostAsyncWithHttpInfo($x_partner_id, $api_v1_labels_search_post_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1LabelsSearchPostAsyncWithHttpInfo($x_partner_id = null, $api_v1_labels_search_post_request = null, string $contentType = self::contentTypes['apiV1LabelsSearchPost'][0])
    {
        $returnType = 'mixed';
        $request = $this->apiV1LabelsSearchPostRequest($x_partner_id, $api_v1_labels_search_post_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiV1LabelsSearchPostRequest($x_partner_id = null, $api_v1_labels_search_post_request = null, string $contentType = self::contentTypes['apiV1LabelsSearchPost'][0])
    {
    ...
    /**
     * Operation apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost
     *
     ...
     * @param  \Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPostRequest|null $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request api_v1_parcels_id_destinationlabel_generate_upload_url_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost'] to see the possible values for this operation
     *
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost200Response|\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost400Response|\Boxnow\Model\ApiV1AuthSessionsPost403Response
     */
    public function apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost($id, $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request = null, string $contentType = self::contentTypes['apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost'][0])
    {
        list($response) = $this->apiV1ParcelsIdDestinationlabelGenerateUploadUrlPostWithHttpInfo($id, $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request, $contentType);
        return $response;
    }

    /**
     * Operation apiV1ParcelsIdDestinationlabelGenerateUploadUrlPostWithHttpInfo
     *
     * Get upload url for a custom label
     *
     * @param  string $id Unique parcel ID. You have received parcel ID after a successful delivery request creation or you can list all parcels, see &#x60;/parcels&#x60; (required)
     * @param  \Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPostRequest|null $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost'] to see the possible values for this operation
     *
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost200Response|\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost400Response|\Boxnow\Model\ApiV1AuthSessionsPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1ParcelsIdDestinationlabelGenerateUploadUrlPostWithHttpInfo($id, $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request = null, string $contentType = self::contentTypes['apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost'][0])
    {
        $request = $this->apiV1ParcelsIdDestinationlabelGenerateUploadUrlPostRequest($id, $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation apiV1ParcelsIdDestinationlabelGenerateUploadUrlPostAsync
     *
     * Get upload url for a custom label
     *
     * @param  string $id Unique parcel ID. You have received parcel ID after a successful delivery request creation or you can list all parcels, see &#x60;/parcels&#x60; (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1ParcelsIdDestinationlabelGenerateUploadUrlPostAsync($id, $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request = null, string $contentType = self::contentTypes['apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost'][0])
    {
        return $this->apiV1ParcelsIdDestinationlabelGenerateUploadUrlPostAsyncWithHttpInfo($id, $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiV1ParcelsIdDestinationlabelGenerateUploadUrlPostAsyncWithHttpInfo
     *
     * Get upload url for a custom label
     *
     * @param  string $id Unique parcel ID. You have received parcel ID after a successful delivery request creation or you can list all parcels, see &#x60;/parcels&#x60; (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1ParcelsIdDestinationlabelGenerateUploadUrlPostAsyncWithHttpInfo($id, $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request = null, string $contentType = self::contentTypes['apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost'][0])
    {
        $returnType = '\Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost200Response';
        $request = $this->apiV1ParcelsIdDestinationlabelGenerateUploadUrlPostRequest($id, $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request, $contentType);
    ...
    /**
     * Create request for operation 'apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost'
     *
     * @param  string $id Unique parcel ID. You have received parcel ID after a successful delivery request creation or you can list all parcels, see &#x60;/parcels&#x60; (required)
     * @param  \Boxnow\Model\ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPostRequest|null $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiV1ParcelsIdDestinationlabelGenerateUploadUrlPostRequest($id, $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request = null, string $contentType = self::contentTypes['apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiV1ParcelsIdDestinationlabelGenerateUploadUrlPost'
            );
        }



        $resourcePath = '/api/v1/parcels/{id}/destinationlabel:generateUploadUrl';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($api_v1_parcels_id_destinationlabel_generate_upload_url_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($api_v1_parcels_id_destinationlabel_generate_upload_url_post_request));
            } else {
                $httpBody = $api_v1_parcels_id_destinationlabel_generate_upload_url_post_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Boxnow\Model\ApiV1ParcelsIdLabelGet200Response|\Boxnow\Model\ApiV1ParcelsIdLabelGet400Response|\Boxnow\Model\ApiV1AuthSessionsPost403Response
     */
     ...
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Boxnow\Model\ApiV1ParcelsIdLabelGet200Response|\Boxnow\Model\ApiV1ParcelsIdLabelGet400Response|\Boxnow\Model\ApiV1AuthSessionsPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1ParcelsIdLabelGetWithHttpInfo($id, string $contentType = self::contentTypes['apiV1ParcelsIdLabelGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Boxnow\Model\ApiV1ParcelsIdLabelGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Boxnow\Model\ApiV1ParcelsIdLabelGet200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Boxnow\Model\ApiV1ParcelsIdLabelGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Boxnow\Model\ApiV1ParcelsIdLabelGet400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Boxnow\Model\ApiV1ParcelsIdLabelGet400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Boxnow\Model\ApiV1ParcelsIdLabelGet400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Boxnow\Model\ApiV1ParcelsIdLabelGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Boxnow\Model\ApiV1ParcelsIdLabelGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Boxnow\Model\ApiV1ParcelsIdLabelGet400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \SplFileObject|\Boxnow\Model\ApiV1AuthSessionsPost403Response
     */
    public function apiV1ParcelsIdLabelTypeGet($id, $type, $dpi = 200, $width = null, $printer_model = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1ParcelsIdLabelTypeGet'][0])
    {
        list($response) = $this->apiV1ParcelsIdLabelTypeGetWithHttpInfo($id, $type, $dpi, $width, $printer_model, $x_partner_id, $contentType);
        return $response;
    }
     ...
     * @return array of \SplFileObject|\Boxnow\Model\ApiV1AuthSessionsPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1ParcelsIdLabelTypeGetWithHttpInfo($id, $type, $dpi = 200, $width = null, $printer_model = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1ParcelsIdLabelTypeGet'][0])
    {
        $request = $this->apiV1ParcelsIdLabelTypeGetRequest($id, $type, $dpi, $width, $printer_model, $x_partner_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1ParcelsIdLabelTypeGetAsync($id, $type, $dpi = 200, $width = null, $printer_model = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1ParcelsIdLabelTypeGet'][0])
    {
        return $this->apiV1ParcelsIdLabelTypeGetAsyncWithHttpInfo($id, $type, $dpi, $width, $printer_model, $x_partner_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1ParcelsIdLabelTypeGetAsyncWithHttpInfo($id, $type, $dpi = 200, $width = null, $printer_model = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1ParcelsIdLabelTypeGet'][0])
    {
        $returnType = '\SplFileObject';
        $request = $this->apiV1ParcelsIdLabelTypeGetRequest($id, $type, $dpi, $width, $printer_model, $x_partner_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiV1ParcelsIdLabelTypeGetRequest($id, $type, $dpi = 200, $width = null, $printer_model = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1ParcelsIdLabelTypeGet'][0])
    {
     ...
     * @param  string|null $content_disposition Specify if the downloaded label will be opened or be downloaded. (optional)
     * @param  string|null $x_partner_id Partner ID you want to manage. You can list partners you are allowed to manage from /entrusted-partners endpoint. (optional)
     ...
     * @return \SplFileObject|\Boxnow\Model\ApiV1AuthSessionsPost403Response
     */
    public function uiV1DeliveryRequestsOrderImportsNumberLabelPdfGet($order_imports_number, $content_disposition = null, $x_partner_id = null, string $contentType = self::contentTypes['uiV1DeliveryRequestsOrderImportsNumberLabelPdfGet'][0])
    {
        list($response) = $this->uiV1DeliveryRequestsOrderImportsNumberLabelPdfGetWithHttpInfo($order_imports_number, $content_disposition, $x_partner_id, $contentType);
        return $response;
    }
     ...
     * @return array of \SplFileObject|\Boxnow\Model\ApiV1AuthSessionsPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function uiV1DeliveryRequestsOrderImportsNumberLabelPdfGetWithHttpInfo($order_imports_number, $content_disposition = null, $x_partner_id = null, string $contentType = self::contentTypes['uiV1DeliveryRequestsOrderImportsNumberLabelPdfGet'][0])
    {
        $request = $this->uiV1DeliveryRequestsOrderImportsNumberLabelPdfGetRequest($order_imports_number, $content_disposition, $x_partner_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uiV1DeliveryRequestsOrderImportsNumberLabelPdfGetAsync($order_imports_number, $content_disposition = null, $x_partner_id = null, string $contentType = self::contentTypes['uiV1DeliveryRequestsOrderImportsNumberLabelPdfGet'][0])
    {
        return $this->uiV1DeliveryRequestsOrderImportsNumberLabelPdfGetAsyncWithHttpInfo($order_imports_number, $content_disposition, $x_partner_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uiV1DeliveryRequestsOrderImportsNumberLabelPdfGetAsyncWithHttpInfo($order_imports_number, $content_disposition = null, $x_partner_id = null, string $contentType = self::contentTypes['uiV1DeliveryRequestsOrderImportsNumberLabelPdfGet'][0])
    {
        $returnType = '\SplFileObject';
        $request = $this->uiV1DeliveryRequestsOrderImportsNumberLabelPdfGetRequest($order_imports_number, $content_disposition, $x_partner_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uiV1DeliveryRequestsOrderImportsNumberLabelPdfGetRequest($order_imports_number, $content_disposition = null, $x_partner_id = null, string $contentType = self::contentTypes['uiV1DeliveryRequestsOrderImportsNumberLabelPdfGet'][0])
    {
