...
class LocationsApi
{
     ...
     *
     * @param  string|null $latlng If applied only locations in the specified radius from this gps coord are returned (optional)
     * @param  float|null $radius Radius in meters to return only locations within selected radius from given GPS location. Ignored if &#x60;latlng&#x60; is not present. (optional, default to 25000)
     * @param  float|null $required_size Return only locations that can accept a package of your &#x60;requiredSize&#x60;. If defined, the value is used based on your trust factor. Otherwise, &#x60;requiredSize&#x60; is automatically set based on your usage. (optional)
     * @param  \Boxnow\Model\LocationType[]|null $location_type Return only locations with given types. If not present, filter is not applied. (optional)
     * @param  string|null $name Return only locations with matching name (optional)
     * @param  string|null $region_language_tag region_language_tag (optional)
     ...
     * @param  float|null $limit Limit the number of returned results. If not defined, all results are returned. (optional)
     ...
     */
    public function apiV1DestinationsGet($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, $x_partner_id = null, $limit = null, string $contentType = self::contentTypes['apiV1DestinationsGet'][0])
    {
        list($response) = $this->apiV1DestinationsGetWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $x_partner_id, $limit, $contentType);
        return $response;
    }
     ...
     * @param  \Boxnow\Model\LocationType[]|null $location_type Return only locations with given types. If not present, filter is not applied. (optional)
     * @param  string|null $name Return only locations with matching name (optional)
     * @param  string|null $region_language_tag (optional)
     * @param  string|null $x_partner_id Partner ID you want to manage. You can list partners you are allowed to manage from /entrusted-partners endpoint. (optional)
     * @param  float|null $limit Limit the number of returned results. If not defined, all results are returned. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1DestinationsGet'] to see the possible values for this operation
     *
     ...
     */
    public function apiV1DestinationsGetWithHttpInfo($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, $x_partner_id = null, $limit = null, string $contentType = self::contentTypes['apiV1DestinationsGet'][0])
    {
        $request = $this->apiV1DestinationsGetRequest($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $x_partner_id, $limit, $contentType);
     ...
     */
    public function apiV1DestinationsGetAsync($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, $x_partner_id = null, $limit = null, string $contentType = self::contentTypes['apiV1DestinationsGet'][0])
    {
        return $this->apiV1DestinationsGetAsyncWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $x_partner_id, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1DestinationsGetAsyncWithHttpInfo($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, $x_partner_id = null, $limit = null, string $contentType = self::contentTypes['apiV1DestinationsGet'][0])
    {
        $returnType = '\Boxnow\Model\ApiV1DestinationsGet200Response';
        $request = $this->apiV1DestinationsGetRequest($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $x_partner_id, $limit, $contentType);
     ...
     */
    public function apiV1DestinationsGetRequest($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, $x_partner_id = null, $limit = null, string $contentType = self::contentTypes['apiV1DestinationsGet'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $region_language_tag,
            'regionLanguageTag', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     */
    public function apiV1OriginsGet($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1OriginsGet'][0])
    {
        list($response) = $this->apiV1OriginsGetWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $x_partner_id, $contentType);
        return $response;
    }
     ...
     */
    public function apiV1OriginsGetWithHttpInfo($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1OriginsGet'][0])
    {
        $request = $this->apiV1OriginsGetRequest($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $x_partner_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1OriginsGetAsync($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1OriginsGet'][0])
    {
        return $this->apiV1OriginsGetAsyncWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $x_partner_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1OriginsGetAsyncWithHttpInfo($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1OriginsGet'][0])
    {
        $returnType = '\Boxnow\Model\ApiV1OriginsGet200Response';
        $request = $this->apiV1OriginsGetRequest($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $x_partner_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiV1OriginsGetRequest($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, $x_partner_id = null, string $contentType = self::contentTypes['apiV1OriginsGet'][0])
    {
