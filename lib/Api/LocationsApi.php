...
/**
     ...
     * @param  \OpenAPI\Client\Model\LocationType[] $location_type Return only locations with given types. If not present, filter is not applied. (optional)
     ...
     * @return \OpenAPI\Client\Model\ApiV1DestinationsGet200Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost400Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost403Response
     */
    ...
    {
        list($response) = $this->apiV1DestinationsGetWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ApiV1DestinationsGet200Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost400Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1DestinationsGetWithHttpInfo($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, string $contentType = self::contentTypes['apiV1DestinationsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ApiV1DestinationsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ApiV1DestinationsGet200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ApiV1DestinationsGet200Response', []),
            ...
            $returnType = '\OpenAPI\Client\Model\ApiV1DestinationsGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ApiV1DestinationsGet200Response',
     ...
     */
    public function apiV1DestinationsGetAsync($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, string $contentType = self::contentTypes['apiV1DestinationsGet'][0])
    {
        return $this->apiV1DestinationsGetAsyncWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function apiV1DestinationsGetRequest($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, string $contentType = self::contentTypes['apiV1DestinationsGet'][0])
    {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ApiV1OriginsGet200Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost400Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost403Response
     */
    ...
    {
        list($response) = $this->apiV1OriginsGetWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ApiV1OriginsGet200Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost400Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1OriginsGetWithHttpInfo($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, string $contentType = self::contentTypes['apiV1OriginsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ApiV1OriginsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ApiV1OriginsGet200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ApiV1OriginsGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\ApiV1OriginsGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ApiV1OriginsGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1OriginsGetAsync($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, string $contentType = self::contentTypes['apiV1OriginsGet'][0])
    {
        return $this->apiV1OriginsGetAsyncWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiV1OriginsGetRequest($latlng = null, $radius = 25000, $required_size = null, $location_type = null, $name = null, $region_language_tag = null, string $contentType = self::contentTypes['apiV1OriginsGet'][0])
    {
