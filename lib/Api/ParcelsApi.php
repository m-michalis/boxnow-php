...
/**
     ...
     * @param  \OpenAPI\Client\Model\ParcelState[] $state state (optional)
     ...
     * @return \OpenAPI\Client\Model\ApiV1ParcelsGet200Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost400Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost403Response
     */
     ...
     * @param  \OpenAPI\Client\Model\ParcelState[] $state (optional)
     * @param  string $created_from UNIX timestamp in milliseconds (optional)
     * @param  string $created_to UNIX timestamp in milliseconds (optional)
     * @param  string $page_token Set this token to return records for given page. You get this for each response. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1ParcelsGet'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ApiV1ParcelsGet200Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost400Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1ParcelsGetWithHttpInfo($q = null, $limit = 50, $order_number = null, $parcel_id = null, $payment_state = null, $payment_mode = null, $state = null, $created_from = null, $created_to = null, $page_token = null, string $contentType = self::contentTypes['apiV1ParcelsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ApiV1ParcelsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ApiV1ParcelsGet200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ApiV1ParcelsGet200Response', []),
            ...
            $returnType = '\OpenAPI\Client\Model\ApiV1ParcelsGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ApiV1ParcelsGet200Response',
     ...
     * @return void
     */
    public function apiV1ParcelsIdcancelPost($id, string $contentType = self::contentTypes['apiV1ParcelsIdcancelPost'][0])
    {
        $this->apiV1ParcelsIdcancelPostWithHttpInfo($id, $contentType);
    }
     ...
     */
    public function apiV1ParcelsIdcancelPostWithHttpInfo($id, string $contentType = self::contentTypes['apiV1ParcelsIdcancelPost'][0])
    {
        $request = $this->apiV1ParcelsIdcancelPostRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1ParcelsIdcancelPostAsync($id, string $contentType = self::contentTypes['apiV1ParcelsIdcancelPost'][0])
    {
        return $this->apiV1ParcelsIdcancelPostAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1ParcelsIdcancelPostAsyncWithHttpInfo($id, string $contentType = self::contentTypes['apiV1ParcelsIdcancelPost'][0])
    {
        $returnType = '';
        $request = $this->apiV1ParcelsIdcancelPostRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiV1ParcelsIdcancelPostRequest($id, string $contentType = self::contentTypes['apiV1ParcelsIdcancelPost'][0])
    {
     ...
     * @return void
     */
    public function apiV1ParcelsIdconfirmAnyapmDeliveryPost($id, string $contentType = self::contentTypes['apiV1ParcelsIdconfirmAnyapmDeliveryPost'][0])
    {
        $this->apiV1ParcelsIdconfirmAnyapmDeliveryPostWithHttpInfo($id, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1ParcelsIdconfirmAnyapmDeliveryPostWithHttpInfo($id, string $contentType = self::contentTypes['apiV1ParcelsIdconfirmAnyapmDeliveryPost'][0])
    {
        $request = $this->apiV1ParcelsIdconfirmAnyapmDeliveryPostRequest($id, $contentType);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ApiV1ParcelsIdConfirmAnyapmDeliveryPost400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 503:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ApiV1ParcelsIdConfirmAnyapmDeliveryPost503Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1ParcelsIdconfirmAnyapmDeliveryPostAsync($id, string $contentType = self::contentTypes['apiV1ParcelsIdconfirmAnyapmDeliveryPost'][0])
    {
        return $this->apiV1ParcelsIdconfirmAnyapmDeliveryPostAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1ParcelsIdconfirmAnyapmDeliveryPostAsyncWithHttpInfo($id, string $contentType = self::contentTypes['apiV1ParcelsIdconfirmAnyapmDeliveryPost'][0])
    {
        $returnType = '';
        $request = $this->apiV1ParcelsIdconfirmAnyapmDeliveryPostRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiV1ParcelsIdconfirmAnyapmDeliveryPostRequest($id, string $contentType = self::contentTypes['apiV1ParcelsIdconfirmAnyapmDeliveryPost'][0])
    {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\OpenAPI\Client\Model\ApiV1AuthSessionsPost400Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost403Response
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\OpenAPI\Client\Model\ApiV1AuthSessionsPost400Response|\OpenAPI\Client\Model\ApiV1AuthSessionsPost403Response, HTTP status code, HTTP response headers (array of strings)
     */
