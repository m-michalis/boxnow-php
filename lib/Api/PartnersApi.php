...
class PartnersApi
{
    ...
    /**
     * Operation apiV1EntrustedPartnersGet
     *
     * Get list of partner you can manage
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1EntrustedPartnersGet'] to see the possible values for this operation
     *
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Boxnow\Model\ApiV1EntrustedPartnersGet200ResponseInner[]
     */
    public function apiV1EntrustedPartnersGet(string $contentType = self::contentTypes['apiV1EntrustedPartnersGet'][0])
    {
        list($response) = $this->apiV1EntrustedPartnersGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation apiV1EntrustedPartnersGetWithHttpInfo
     *
     * Get list of partner you can manage
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1EntrustedPartnersGet'] to see the possible values for this operation
     ...
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Boxnow\Model\ApiV1EntrustedPartnersGet200ResponseInner[], HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1EntrustedPartnersGetWithHttpInfo(string $contentType = self::contentTypes['apiV1EntrustedPartnersGet'][0])
    {
        $request = $this->apiV1EntrustedPartnersGetRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Boxnow\Model\ApiV1EntrustedPartnersGet200ResponseInner[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Boxnow\Model\ApiV1EntrustedPartnersGet200ResponseInner[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Boxnow\Model\ApiV1EntrustedPartnersGet200ResponseInner[]', []),
            ...
            $returnType = '\Boxnow\Model\ApiV1EntrustedPartnersGet200ResponseInner[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Boxnow\Model\ApiV1EntrustedPartnersGet200ResponseInner[]',
    ...
    /**
     * Operation apiV1EntrustedPartnersGetAsync
     *
     * Get list of partner you can manage
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1EntrustedPartnersGet'] to see the possible values for this operation
     ...
     */
    public function apiV1EntrustedPartnersGetAsync(string $contentType = self::contentTypes['apiV1EntrustedPartnersGet'][0])
    {
        return $this->apiV1EntrustedPartnersGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiV1EntrustedPartnersGetAsyncWithHttpInfo
     *
     * Get list of partner you can manage
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1EntrustedPartnersGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1EntrustedPartnersGetAsyncWithHttpInfo(string $contentType = self::contentTypes['apiV1EntrustedPartnersGet'][0])
    {
        $returnType = '\Boxnow\Model\ApiV1EntrustedPartnersGet200ResponseInner[]';
        $request = $this->apiV1EntrustedPartnersGetRequest($contentType);
    ...
    /**
     * Create request for operation 'apiV1EntrustedPartnersGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1EntrustedPartnersGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function apiV1EntrustedPartnersGetRequest(string $contentType = self::contentTypes['apiV1EntrustedPartnersGet'][0])
    {


        $resourcePath = '/api/v1/entrusted-partners';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
