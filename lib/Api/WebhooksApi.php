...
class WebhooksApi
{
    ...
    /**
     * Operation yourWebhookEndpointPost
     *
     * Your webhook endpoint. Used to send You parcel events messages. You should set this endpoint in your BoxNow account.
     *
     * @param  string $your_webhook_endpoint your_webhook_endpoint (required)
     * @param  string|null $your_optional_header your_optional_header (optional)
     * @param  \Boxnow\Model\WebhookMessage|null $webhook_message webhook_message (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['yourWebhookEndpointPost'] to see the possible values for this operation
     *
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function yourWebhookEndpointPost($your_webhook_endpoint, $your_optional_header = null, $webhook_message = null, string $contentType = self::contentTypes['yourWebhookEndpointPost'][0])
    {
        $this->yourWebhookEndpointPostWithHttpInfo($your_webhook_endpoint, $your_optional_header, $webhook_message, $contentType);
    }

    /**
     * Operation yourWebhookEndpointPostWithHttpInfo
     *
     * Your webhook endpoint. Used to send You parcel events messages. You should set this endpoint in your BoxNow account.
     *
     * @param  string $your_webhook_endpoint (required)
     * @param  string|null $your_optional_header (optional)
     * @param  \Boxnow\Model\WebhookMessage|null $webhook_message (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['yourWebhookEndpointPost'] to see the possible values for this operation
     *
     * @throws \Boxnow\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function yourWebhookEndpointPostWithHttpInfo($your_webhook_endpoint, $your_optional_header = null, $webhook_message = null, string $contentType = self::contentTypes['yourWebhookEndpointPost'][0])
    {
        $request = $this->yourWebhookEndpointPostRequest($your_webhook_endpoint, $your_optional_header, $webhook_message, $contentType);
    ...
    /**
     * Operation yourWebhookEndpointPostAsync
     *
     * Your webhook endpoint. Used to send You parcel events messages. You should set this endpoint in your BoxNow account.
     *
     * @param  string $your_webhook_endpoint (required)
     ...
     */
    public function yourWebhookEndpointPostAsync($your_webhook_endpoint, $your_optional_header = null, $webhook_message = null, string $contentType = self::contentTypes['yourWebhookEndpointPost'][0])
    {
        return $this->yourWebhookEndpointPostAsyncWithHttpInfo($your_webhook_endpoint, $your_optional_header, $webhook_message, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation yourWebhookEndpointPostAsyncWithHttpInfo
     *
     * Your webhook endpoint. Used to send You parcel events messages. You should set this endpoint in your BoxNow account.
     *
     * @param  string $your_webhook_endpoint (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function yourWebhookEndpointPostAsyncWithHttpInfo($your_webhook_endpoint, $your_optional_header = null, $webhook_message = null, string $contentType = self::contentTypes['yourWebhookEndpointPost'][0])
    {
        $returnType = '';
        $request = $this->yourWebhookEndpointPostRequest($your_webhook_endpoint, $your_optional_header, $webhook_message, $contentType);
    ...
    /**
     * Create request for operation 'yourWebhookEndpointPost'
     *
     * @param  string $your_webhook_endpoint (required)
     * @param  string|null $your_optional_header (optional)
     * @param  \Boxnow\Model\WebhookMessage|null $webhook_message (optional)
     ...
     */
    public function yourWebhookEndpointPostRequest($your_webhook_endpoint, $your_optional_header = null, $webhook_message = null, string $contentType = self::contentTypes['yourWebhookEndpointPost'][0])
    {

        // verify the required parameter 'your_webhook_endpoint' is set
        if ($your_webhook_endpoint === null || (is_array($your_webhook_endpoint) && count($your_webhook_endpoint) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $your_webhook_endpoint when calling yourWebhookEndpointPost'
            );
        }
        ...
        $resourcePath = '/{your-webhook-endpoint}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // header params
        if ($your_optional_header !== null) {
            $headerParams['your-optional-header'] = ObjectSerializer::toHeaderValue($your_optional_header);
        }

        // path params
        if ($your_webhook_endpoint !== null) {
            $resourcePath = str_replace(
                '{' . 'your-webhook-endpoint' . '}',
                ObjectSerializer::toPathValue($your_webhook_endpoint),
                $resourcePath
            );
        }
        ...
        // for model (json/xml)
        if (isset($webhook_message)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_message));
            } else {
                $httpBody = $webhook_message;
            }
