<?php
/**
 * AllOfDeliveryRequestV2Destination
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AllOfDeliveryRequestV2Destination Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AllOfDeliveryRequestV2Destination implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AllOfDeliveryRequestV2Destination';
    ...
    {
        $this->container['delivery_partner_id'] = isset($data['delivery_partner_id']) ? $data['delivery_partner_id'] : null;
    }
     ...
     *
     * @param string $delivery_partner_id Use if want to deliver the parcels via another delivery service. ID of Delivery partner, see `/delivery-partners`
     *
     * @return $this
     */
