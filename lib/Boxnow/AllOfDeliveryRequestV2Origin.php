...
/**
 * AllOfDeliveryRequestV2Origin Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AllOfDeliveryRequestV2Origin implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AllOfDeliveryRequestV2Origin';
     ...
     *
     * @param string $delivery_partner_id Use if want to pickup the parcels via another delivery service. ID of Delivery partner, see `/delivery-partners`
     *
     * @return $this
     */
