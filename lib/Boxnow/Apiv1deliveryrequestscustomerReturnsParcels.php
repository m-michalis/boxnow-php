<?php
/**
 * Apiv1deliveryrequestscustomerReturnsParcels
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * Apiv1deliveryrequestscustomerReturnsParcels Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Apiv1deliveryrequestscustomerReturnsParcels implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'apiv1deliveryrequestscustomerReturns_parcels';
...
'size' => 'getSize'    ];
     ...
     * Sets size
     *
     * @param float $size Compartment size required for the package
     *
     * @return $this
     */
