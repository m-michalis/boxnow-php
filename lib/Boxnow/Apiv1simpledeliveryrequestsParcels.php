...
/**
 * Apiv1simpledeliveryrequestsParcels Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Apiv1simpledeliveryrequestsParcels implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'apiv1simpledeliveryrequests_parcels';
...
'destination_delivery_parcel_id' => 'getDestinationDeliveryParcelId'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['value'] = isset($data['value']) ? $data['value'] : '0.00';
     ...
     * Sets id
     *
     * @param string $id Reference number in Your system
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Contents name label
     *
     * @return $this
     */
     ...
     * Sets size
     *
     * @param float $size Compartment size required for the package. Required for `any-apm` origin.
     *
     * @return $this
     */
