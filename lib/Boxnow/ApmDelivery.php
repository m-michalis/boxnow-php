 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApmDelivery implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApmDelivery';
...
'destination_public_id' => 'getDestinationPublicId'    ];
    ...
    const TYPE_APM_DELIVERY = 'apm-delivery';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['destination_public_id'] = isset($data['destination_public_id']) ? $data['destination_public_id'] : null;
    }
