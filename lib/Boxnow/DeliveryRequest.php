...
self::TYPE_OF_SERVICE_NEXT_DAY,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['notify_smson_accepted'] = isset($data['notify_smson_accepted']) ? $data['notify_smson_accepted'] : null;
     ...
     *
     * @param string $notify_smson_accepted Phone number in international format. If set, we send a sms notification to this phone number.
     *
     * @return $this
     */
