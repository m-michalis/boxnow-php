...
/**
 * DeliveryRequestItems Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeliveryRequestItems implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeliveryRequest_items';
...
'destination_delivery_parcel_id' => 'getDestinationDeliveryParcelId'    ];
     ...
     * Sets id
     *
     * @param string $id Item reference number in Your system
     *
     * @return $this
     */
