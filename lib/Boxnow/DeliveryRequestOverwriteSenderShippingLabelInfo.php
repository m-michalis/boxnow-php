 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeliveryRequestOverwriteSenderShippingLabelInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeliveryRequest_overwriteSenderShippingLabelInfo';
...
'row4' => 'getRow4'    ];
    ...
    {
        $this->container['row1'] = isset($data['row1']) ? $data['row1'] : null;
        $this->container['row2'] = isset($data['row2']) ? $data['row2'] : null;
        $this->container['row3'] = isset($data['row3']) ? $data['row3'] : null;
        $this->container['row4'] = isset($data['row4']) ? $data['row4'] : null;
    }
