 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeliveryRequestV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeliveryRequestV2';
...
'origin' => 'AllOfDeliveryRequestV2Origin',
'destination' => 'AllOfDeliveryRequestV2Destination',
'parcels' => '\Swagger\Client\Boxnow\DeliveryRequestV2Parcels[]'    ];
...
self::PAYMENT_MODE_COD,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_mode'] = isset($data['payment_mode']) ? $data['payment_mode'] : 'prepaid';
        $this->container['amount_to_be_collected'] = isset($data['amount_to_be_collected']) ? $data['amount_to_be_collected'] : null;
        $this->container['allow_return'] = isset($data['allow_return']) ? $data['allow_return'] : false;
     ...
     * Gets origin
     *
     * @return AllOfDeliveryRequestV2Origin
     */
     ...
     * Sets origin
     *
     * @param AllOfDeliveryRequestV2Origin $origin origin
     *
     * @return $this
     */
     ...
     * Gets destination
     *
     * @return AllOfDeliveryRequestV2Destination
     */
     ...
     * Sets destination
     *
     * @param AllOfDeliveryRequestV2Destination $destination destination
     *
     * @return $this
     */
     ...
     * Gets parcels
     *
     * @return \Swagger\Client\Boxnow\DeliveryRequestV2Parcels[]
     */
     ...
     * Sets parcels
     *
     * @param \Swagger\Client\Boxnow\DeliveryRequestV2Parcels[] $parcels List of parcels you want to send via BoxNow.
     *
     * @return $this
     */
