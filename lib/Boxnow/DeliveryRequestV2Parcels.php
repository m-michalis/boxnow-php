...
/**
 * DeliveryRequestV2Parcels Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeliveryRequestV2Parcels implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeliveryRequestV2_parcels';
...
'destination_delivery_parcel_id' => 'getDestinationDeliveryParcelId'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['compartment_size'] = isset($data['compartment_size']) ? $data['compartment_size'] : null;
        $this->container['origin_delivery_parcel_id'] = isset($data['origin_delivery_parcel_id']) ? $data['origin_delivery_parcel_id'] : null;
        $this->container['destination_delivery_parcel_id'] = isset($data['destination_delivery_parcel_id']) ? $data['destination_delivery_parcel_id'] : null;
    }
     ...
     * Sets id
     *
     * @param string $id Parcel reference number in Your system
     *
     * @return $this
     */
     ...
     * Sets weight
     *
     * @param float $weight Item weight in kg
     *
     * @return $this
     */
     ...
     *
     * @param float $compartment_size Compartment size required for the package. Required only for `apm`/`any-apm` origin.
     *
     * @return $this
     */
     ...
     *
     * @param string $origin_delivery_parcel_id Parcel id of 3rd party delivery service. Fill in in case you are using other delivery service to deliver us the order.
     *
     * @return $this
     */
     ...
     *
     * @param string $destination_delivery_parcel_id Parcel id of 3rd party delivery service. Fill in in case you are using other delivery service for final delivery.
     *
     * @return $this
     */
