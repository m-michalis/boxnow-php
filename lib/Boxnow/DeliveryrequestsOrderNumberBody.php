<?php
/**
 * DeliveryrequestsOrderNumberBody
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * DeliveryrequestsOrderNumberBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeliveryrequestsOrderNumberBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'deliveryrequests_orderNumber_body';
     ...
     * Sets allow_return
     *
     * @param bool $allow_return Send true if you want the client to be able to return the order. False if you don't want to allow it.
     *
     * @return $this
     */
