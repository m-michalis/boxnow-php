...
class Destination extends Location 
{
    ...
    protected static $swaggerTypes = [
        'expected_delivery_time' => '\Swagger\Client\Boxnow\\DateTime'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['expected_delivery_time'] = isset($data['expected_delivery_time']) ? $data['expected_delivery_time'] : null;
    }
     ...
     *
     * @param \Swagger\Client\Boxnow\\DateTime $expected_delivery_time expected_delivery_time
     *
     * @return $this
     */
