 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EventsInner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Events_inner';
...
'postal_code' => 'string',
'create_time' => 'AllOfEventsInnerCreateTime'    ];
...
const TYPE_IN_DEPOT = 'in-depot';
const TYPE_FINAL_DESTINATION = 'final-destination';
const TYPE_CANCELED = 'canceled';
const TYPE_ACCEPTED_FOR_RETURN = 'accepted-for-return';
const TYPE_MISSING = 'missing';
const TYPE_ACCEPTED_TO_LOCKER = 'accepted-to-locker';
...
self::TYPE_RETURNED,
self::TYPE_IN_DEPOT,
self::TYPE_FINAL_DESTINATION,
self::TYPE_CANCELED,
self::TYPE_ACCEPTED_FOR_RETURN,
self::TYPE_MISSING,
self::TYPE_ACCEPTED_TO_LOCKER,        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['location_display_name'] = isset($data['location_display_name']) ? $data['location_display_name'] : null;
     ...
     *
     * @param string $location_display_name Event source location
     *
     * @return $this
     */
     ...
     * Sets postal_code
     *
     * @param string $postal_code Event source location postal code
     *
     * @return $this
     */
     ...
     * Gets create_time
     *
     * @return AllOfEventsInnerCreateTime
     */
     ...
     * Sets create_time
     *
     * @param AllOfEventsInnerCreateTime $create_time create_time
     *
     * @return $this
     */
