...
/**
 * InlineResponse2009Pagination Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2009Pagination implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_9_pagination';
...
'prev' => 'getPrev'    ];
     ...
     * Sets next
     *
     * @param string $next Token to use to get to the next page
     *
     * @return $this
     */
     ...
     * Sets prev
     *
     * @param string $prev Token to use to get to the previous page
     *
     * @return $this
     */
