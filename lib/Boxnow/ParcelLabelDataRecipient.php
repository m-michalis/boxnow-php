 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ParcelLabelDataRecipient implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParcelLabelData_recipient';
    ...
    {
        $this->container['raw_info'] = isset($data['raw_info']) ? $data['raw_info'] : null;
    }
