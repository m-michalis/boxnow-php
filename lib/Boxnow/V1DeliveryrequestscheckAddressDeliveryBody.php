<?php
/**
 * V1DeliveryrequestscheckAddressDeliveryBody
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V1DeliveryrequestscheckAddressDeliveryBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1DeliveryrequestscheckAddressDeliveryBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1_deliveryrequestscheckAddressDelivery_body';
...
'compartment_size' => 'getCompartmentSize'    ];
     ...
     * Sets address
     *
     * @param string $address Address you want to deliver to
     *
     * @return $this
     */
     ...
     * Sets radius
     *
     * @param float $radius Radius in meters. Location must be in this radius from the input address.
     *
     * @return $this
     */
     ...
     *
     * @param float $compartment_size Compartment size required for the package.
     *
     * @return $this
     */
