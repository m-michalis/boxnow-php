...
/**
 * V1DeliveryrequestsfromCsvBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1DeliveryrequestsfromCsvBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1_deliveryrequestsfromCsv_body';
...
'file' => 'getFile'    ];
    ...
    const TYPE_WAREHOUSE = 'from-warehouse';
const TYPE_ANYAPM = 'from-anyapm';
