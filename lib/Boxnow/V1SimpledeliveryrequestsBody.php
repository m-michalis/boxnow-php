...
/**
 * V1SimpledeliveryrequestsBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1SimpledeliveryrequestsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1_simpledeliveryrequests_body';
    ...
    protected static $swaggerTypes = [
        'origin' => '\Swagger\Client\Boxnow\Apiv1simpledeliveryrequestsOrigin',
'destination' => 'AllOfv1SimpledeliveryrequestsBodyDestination',
...
'parcel_size' => 'float',
'parcels' => '\Swagger\Client\Boxnow\Apiv1simpledeliveryrequestsParcels[]'    ];
...
'parcels' => 'getParcels'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['parcel_size'] = isset($data['parcel_size']) ? $data['parcel_size'] : null;
     ...
     * Gets origin
     *
     * @return \Swagger\Client\Boxnow\Apiv1simpledeliveryrequestsOrigin
     */
     ...
     * Sets origin
     *
     * @param \Swagger\Client\Boxnow\Apiv1simpledeliveryrequestsOrigin $origin origin
     *
     * @return $this
     */
     ...
     * Gets destination
     *
     * @return AllOfv1SimpledeliveryrequestsBodyDestination
     */
     ...
     * Sets destination
     *
     * @param AllOfv1SimpledeliveryrequestsBodyDestination $destination destination
     *
     * @return $this
     */
     ...
     * Sets parcel_size
     *
     * @param float $parcel_size Package size 1, 2, 3. Mandatory for delivery to AnyAPM. Default for created parcels, but can be overriden on parcel level for individual parcels.
     *
     * @return $this
     */
     ...
     * Gets parcels
     *
     * @return \Swagger\Client\Boxnow\Apiv1simpledeliveryrequestsParcels[]
     */
     ...
     * Sets parcels
     *
     * @param \Swagger\Client\Boxnow\Apiv1simpledeliveryrequestsParcels[] $parcels Use to give us more info about the parcels. If not defined, one parcel is automatically created.
     *
     * @return $this
     */
