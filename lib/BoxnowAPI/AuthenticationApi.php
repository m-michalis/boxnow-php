...
class AuthenticationApi
{
     ...
     *
     * @param  \Swagger\Client\Boxnow\V1AuthsessionsBody $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Boxnow\InlineResponse200
     */
    public function apiV1AuthSessionsPost($body = null)
    {
        list($response) = $this->apiV1AuthSessionsPostWithHttpInfo($body);
        return $response;
    }
     ...
     * Obtain authentication tokens
     *
     * @param  \Swagger\Client\Boxnow\V1AuthsessionsBody $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Boxnow\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1AuthSessionsPostWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Boxnow\InlineResponse200';
        $request = $this->apiV1AuthSessionsPostRequest($body);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Boxnow\InlineResponse200',
     ...
     */
    public function apiV1AuthSessionsPostAsync($body = null)
    {
        return $this->apiV1AuthSessionsPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1AuthSessionsPostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Boxnow\InlineResponse200';
        $request = $this->apiV1AuthSessionsPostRequest($body);
     ...
     */
    protected function apiV1AuthSessionsPostRequest($body = null)
    {
