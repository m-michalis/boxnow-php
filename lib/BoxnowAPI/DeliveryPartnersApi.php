...
class DeliveryPartnersApi
{
     ...
     * @return \Swagger\Client\Boxnow\InlineResponse20012
     */
    public function apiV1DeliveryPartnersGet()
    {
        list($response) = $this->apiV1DeliveryPartnersGetWithHttpInfo();
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Boxnow\InlineResponse20012, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1DeliveryPartnersGetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Boxnow\InlineResponse20012';
        $request = $this->apiV1DeliveryPartnersGetRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Boxnow\InlineResponse20012',
     ...
     */
    public function apiV1DeliveryPartnersGetAsync()
    {
        return $this->apiV1DeliveryPartnersGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1DeliveryPartnersGetAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Boxnow\InlineResponse20012';
        $request = $this->apiV1DeliveryPartnersGetRequest();
     ...
     */
    protected function apiV1DeliveryPartnersGetRequest()
    {
