...
class LocationsApi
{
     ...
     * @param  \Swagger\Client\Boxnow\LanguageTag $region_language_tag region_language_tag (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Boxnow\InlineResponse2001
     */
    public function apiV1DestinationsGet($latlng = null, $radius = '25000', $required_size = null, $location_type = null, $name = null, $region_language_tag = null)
    {
        list($response) = $this->apiV1DestinationsGetWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag);
        return $response;
    }
     ...
     * @param  \Swagger\Client\Boxnow\LocationType[] $location_type Return only locations with given types. If not present, filter is not applied. (optional)
     * @param  string $name Return only locations with matching name (optional)
     * @param  \Swagger\Client\Boxnow\LanguageTag $region_language_tag (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Boxnow\InlineResponse2001, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1DestinationsGetWithHttpInfo($latlng = null, $radius = '25000', $required_size = null, $location_type = null, $name = null, $region_language_tag = null)
    {
        $returnType = '\Swagger\Client\Boxnow\InlineResponse2001';
        $request = $this->apiV1DestinationsGetRequest($latlng, $radius, $required_size, $location_type, $name, $region_language_tag);
     ...
     */
    public function apiV1DestinationsGetAsync($latlng = null, $radius = '25000', $required_size = null, $location_type = null, $name = null, $region_language_tag = null)
    {
        return $this->apiV1DestinationsGetAsyncWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1DestinationsGetAsyncWithHttpInfo($latlng = null, $radius = '25000', $required_size = null, $location_type = null, $name = null, $region_language_tag = null)
    {
        $returnType = '\Swagger\Client\Boxnow\InlineResponse2001';
        $request = $this->apiV1DestinationsGetRequest($latlng, $radius, $required_size, $location_type, $name, $region_language_tag);
     ...
     */
    protected function apiV1DestinationsGetRequest($latlng = null, $radius = '25000', $required_size = null, $location_type = null, $name = null, $region_language_tag = null)
    {
        ...
        // query params
        if ($region_language_tag !== null) {
            $queryParams['regionLanguageTag'] = ObjectSerializer::toQueryValue($region_language_tag, null);
        }
     ...
     */
    public function apiV1OriginsGet($latlng = null, $radius = '25000', $required_size = null, $location_type = null, $name = null, $region_language_tag = null)
    {
        list($response) = $this->apiV1OriginsGetWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag);
        return $response;
    }
     ...
     */
    public function apiV1OriginsGetWithHttpInfo($latlng = null, $radius = '25000', $required_size = null, $location_type = null, $name = null, $region_language_tag = null)
    {
        $returnType = '\Swagger\Client\Boxnow\InlineResponse2002';
        $request = $this->apiV1OriginsGetRequest($latlng, $radius, $required_size, $location_type, $name, $region_language_tag);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1OriginsGetAsync($latlng = null, $radius = '25000', $required_size = null, $location_type = null, $name = null, $region_language_tag = null)
    {
        return $this->apiV1OriginsGetAsyncWithHttpInfo($latlng, $radius, $required_size, $location_type, $name, $region_language_tag)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1OriginsGetAsyncWithHttpInfo($latlng = null, $radius = '25000', $required_size = null, $location_type = null, $name = null, $region_language_tag = null)
    {
        $returnType = '\Swagger\Client\Boxnow\InlineResponse2002';
        $request = $this->apiV1OriginsGetRequest($latlng, $radius, $required_size, $location_type, $name, $region_language_tag);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiV1OriginsGetRequest($latlng = null, $radius = '25000', $required_size = null, $location_type = null, $name = null, $region_language_tag = null)
    {
