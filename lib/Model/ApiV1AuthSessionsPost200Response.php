...
/**
 * ApiV1AuthSessionsPost200Response Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1AuthSessionsPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_auth_sessions_post_200_response';
    ...
    */
     ...
     * Sets expires_in
     *
     * @param float $expires_in Number of seconds for which the access token is valid
     *
     * @return self
     */
