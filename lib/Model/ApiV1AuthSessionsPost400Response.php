...
/**
 * ApiV1AuthSessionsPost400Response Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1AuthSessionsPost400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_auth_sessions_post_400_response';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code See Error codes section for meaning of the code
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Developer/internal description of the error
     *
     * @return self
     */
