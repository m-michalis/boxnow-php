...
/**
 * ApiV1AuthSessionsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1AuthSessionsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_auth_sessions_post_request';
    ...
    */
     ...
     * Sets grant_type
     *
     * @param string $grant_type The grant_type parameter must be set to client_credentials.
     *
     * @return self
     */
     ...
     * Sets client_id
     *
     * @param string $client_id Your application's Client ID. You can get this from our support
     *
     * @return self
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret Your application's Client Secret. You can get this from our support
     *
     * @return self
     */
