...
class ApiV1DeliveryPartnersGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Boxnow\Model\ApiV1DeliveryPartnersGet200ResponseDataInner[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Boxnow\Model\ApiV1DeliveryPartnersGet200ResponseDataInner[]|null
     */
     ...
     * Sets data
     *
     * @param \Boxnow\Model\ApiV1DeliveryPartnersGet200ResponseDataInner[]|null $data data
     *
     * @return self
     */
