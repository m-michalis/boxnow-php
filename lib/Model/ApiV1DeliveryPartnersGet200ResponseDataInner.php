...
/**
 * ApiV1DeliveryPartnersGet200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DeliveryPartnersGet200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_delivery_partners_get_200_response_data_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique Delivery partner ID
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string $code Unique Delivery partner code
     *
     * @return self
     */
