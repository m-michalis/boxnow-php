...
/**
 * ApiV1DeliveryRequestsCheckAddressDeliveryPost200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DeliveryRequestsCheckAddressDeliveryPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_delivery_requests_checkAddressDelivery_post_200_response';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'type' => '\OpenAPI\Client\Model\LocationType',
        'image' => 'string',
        'lat' => 'string',
        'lng' => 'string',
        'region' => 'string',
    ...
    */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\LocationType
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\LocationType $type type
     *
     * @return self
     */
     ...
     * Sets distance
     *
     * @param float $distance Distance from the input address in meters.
     *
     * @return self
     */
