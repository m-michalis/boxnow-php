...
/**
 * ApiV1DeliveryRequestsCheckAddressDeliveryPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DeliveryRequestsCheckAddressDeliveryPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_delivery_requests_checkAddressDelivery_post_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('radius', $data ?? [], 500);
