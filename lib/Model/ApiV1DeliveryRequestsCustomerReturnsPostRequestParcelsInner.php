...
/**
 * ApiV1DeliveryRequestsCustomerReturnsPostRequestParcelsInner Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DeliveryRequestsCustomerReturnsPostRequestParcelsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_delivery_requests_customerReturns_post_request_parcels_inner';
    ...
    */
     ...
     * Sets weight
     *
     * @param float|null $weight Item weight in kg. Must only contain number between 0 and 10^6. Will be rounded to 2 decimals.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param float|null $size Compartment size required for the package
     *
     * @return self
     */
