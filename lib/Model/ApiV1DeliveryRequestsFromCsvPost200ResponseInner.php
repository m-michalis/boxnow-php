...
/**
 * ApiV1DeliveryRequestsFromCsvPost200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DeliveryRequestsFromCsvPost200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_delivery_requests_fromCsv_post_200_response_inner';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'destination' => '\OpenAPI\Client\Model\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerDestination',
        'parcels' => '\OpenAPI\Client\Model\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerParcelsInner[]'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID of the accepted order in our system. Can be passed to support in case of problems
     *
     * @return self
     */
     ...
     * Gets destination
     *
     * @return \OpenAPI\Client\Model\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerDestination|null
     */
     ...
     * Sets destination
     *
     * @param \OpenAPI\Client\Model\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerDestination|null $destination destination
     *
     * @return self
     */
     ...
     * Gets parcels
     *
     * @return \OpenAPI\Client\Model\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerParcelsInner[]
     */
     ...
     * Sets parcels
     *
     * @param \OpenAPI\Client\Model\ApiV1DeliveryRequestsFromCsvPost200ResponseInnerParcelsInner[] $parcels parcels
     *
     * @return self
     */
