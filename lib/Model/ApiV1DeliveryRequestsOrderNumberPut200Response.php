...
/**
 * ApiV1DeliveryRequestsOrderNumberPut200Response Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DeliveryRequestsOrderNumberPut200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_delivery_requests__orderNumber__put_200_response';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Id of the accepted order that can be passed to support in case of problems
     *
     * @return self
     */
