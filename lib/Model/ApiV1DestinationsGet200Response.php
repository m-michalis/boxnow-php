...
/**
 * ApiV1DestinationsGet200Response Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DestinationsGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_destinations_get_200_response';
    ...
    */
     ...
     * Gets data
     *
     * @return \Boxnow\Model\Destination[]|null
     */
     ...
     * Sets data
     *
     * @param \Boxnow\Model\Destination[]|null $data data
     *
     * @return self
     */
