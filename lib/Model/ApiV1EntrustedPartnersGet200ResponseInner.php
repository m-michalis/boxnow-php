...
/**
 * ApiV1EntrustedPartnersGet200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1EntrustedPartnersGet200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_entrusted_partners_get_200_response_inner';
    ...
    protected static $openAPITypes = [
        ...
        'customer_returns_max_allowed_size' => 'float',
        'email' => 'string',
        'phone_number' => 'string',
        'permission' => '\Boxnow\Model\PartnerPermission',
        'region' => 'string',
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'display_name' => null,
        'assigned_currency' => 'iso4217',
        'customer_returns_max_allowed_size' => null,
        'email' => null,
        'phone_number' => null,
        'permission' => null,
        'region' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'display_name' => false,
        'assigned_currency' => false,
        'customer_returns_max_allowed_size' => false,
        'email' => false,
        'phone_number' => false,
        'permission' => false,
        'region' => false,
    ...
    protected static $attributeMap = [
        ...
        'assigned_currency' => 'assignedCurrency',
        'customer_returns_max_allowed_size' => 'customerReturnsMaxAllowedSize',
        'email' => 'email',
    ...
    protected static $setters = [
        ...
        'assigned_currency' => 'setAssignedCurrency',
        'customer_returns_max_allowed_size' => 'setCustomerReturnsMaxAllowedSize',
        'email' => 'setEmail',
    ...
    protected static $getters = [
        ...
        'assigned_currency' => 'getAssignedCurrency',
        'customer_returns_max_allowed_size' => 'getCustomerReturnsMaxAllowedSize',
        'email' => 'getEmail',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('assigned_currency', $data ?? [], null);
        $this->setIfExists('customer_returns_max_allowed_size', $data ?? [], null);
        $this->setIfExists('email', $data ?? [], null);
        $this->setIfExists('phone_number', $data ?? [], null);
        $this->setIfExists('permission', $data ?? [], null);
        $this->setIfExists('region', $data ?? [], null);
        $this->setIfExists('shipping_regions', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['assigned_currency'] === null) {
            $invalidProperties[] = "'assigned_currency' can't be null";
        }
        ...
        if ($this->container['shipping_regions'] === null) {
            $invalidProperties[] = "'shipping_regions' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id Unique Partner ID. Use this for X-PartnerID header.
     *
     * @return self
     */
    ...
    /**
     * Gets assigned_currency
     *
     * @return string
     */
    public function getAssignedCurrency()
    {
        return $this->container['assigned_currency'];
    }

    /**
     * Sets assigned_currency
     *
     * @param string $assigned_currency assigned_currency
     *
     * @return self
     */
    public function setAssignedCurrency($assigned_currency)
    {
        if (is_null($assigned_currency)) {
            throw new \InvalidArgumentException('non-nullable assigned_currency cannot be null');
        }
        $this->container['assigned_currency'] = $assigned_currency;

        return $this;
    }

    /**
     * Gets customer_returns_max_allowed_size
     *
     * @return float|null
     */
    public function getCustomerReturnsMaxAllowedSize()
    {
        return $this->container['customer_returns_max_allowed_size'];
    }

    /**
     * Sets customer_returns_max_allowed_size
     *
     * @param float|null $customer_returns_max_allowed_size Maximum allowed parcel size for customer returns
     *
     * @return self
     */
    public function setCustomerReturnsMaxAllowedSize($customer_returns_max_allowed_size)
    {
        if (is_null($customer_returns_max_allowed_size)) {
            throw new \InvalidArgumentException('non-nullable customer_returns_max_allowed_size cannot be null');
        }
        $this->container['customer_returns_max_allowed_size'] = $customer_returns_max_allowed_size;
     ...
     * Gets permission
     *
     * @return \Boxnow\Model\PartnerPermission
     */
     ...
     * Sets permission
     *
     * @param \Boxnow\Model\PartnerPermission $permission permission
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string $region Region where contract was signed (CP 47 language tag format)
     *
     * @return self
     */
     ...
     *
     * @param string[] $shipping_regions shipping_regions
     *
     * @return self
     */
    public function setShippingRegions($shipping_regions)
    {
        if (is_null($shipping_regions)) {
            throw new \InvalidArgumentException('non-nullable shipping_regions cannot be null');
        }
