...
/**
 * ApiV1OriginsGet200Response Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1OriginsGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_origins_get_200_response';
    ...
    */
     ...
     * Gets data
     *
     * @return \Boxnow\Model\Location[]|null
     */
     ...
     * Sets data
     *
     * @param \Boxnow\Model\Location[]|null $data data
     *
     * @return self
     */
