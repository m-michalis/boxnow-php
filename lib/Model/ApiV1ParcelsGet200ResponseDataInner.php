...
class ApiV1ParcelsGet200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'state' => '\OpenAPI\Client\Model\ParcelState',
        'name' => 'string',
        'value' => 'string',
        'weight' => 'string',
        ...
        'item_ref_id' => 'string',
        'allow_return' => 'bool',
        'delivery_request' => '\OpenAPI\Client\Model\DeliveryRequest',
        'events' => '\OpenAPI\Client\Model\EventsInner[]',
        'parcel_label_url' => 'string',
        'order_label_url' => 'string',
        'cancelation_requested' => 'bool',
        'payment' => '\OpenAPI\Client\Model\DeliveryPayment',
    ...
    */
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Model\ParcelState
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\ParcelState $state state
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\DeliveryRequest
     */
     ...
     *
     * @param \OpenAPI\Client\Model\DeliveryRequest $delivery_request delivery_request
     *
     * @return self
     */
     ...
     * Gets events
     *
     * @return \OpenAPI\Client\Model\EventsInner[]|null
     */
     ...
     * Sets events
     *
     * @param \OpenAPI\Client\Model\EventsInner[]|null $events events
     *
     * @return self
     */
     ...
     * Gets payment
     *
     * @return \OpenAPI\Client\Model\DeliveryPayment|null
     */
     ...
     * Sets payment
     *
     * @param \OpenAPI\Client\Model\DeliveryPayment|null $payment payment
     *
     * @return self
     */
