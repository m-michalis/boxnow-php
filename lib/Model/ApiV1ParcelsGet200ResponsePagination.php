...
/**
 * ApiV1ParcelsGet200ResponsePagination Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1ParcelsGet200ResponsePagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_parcels_get_200_response_pagination';
    ...
    */
     ...
     * Sets first
     *
     * @param string $first Token to use to get to the first page
     *
     * @return self
     */
     ...
     * Sets last
     *
     * @param string $last Token to use to get to the last page
     *
     * @return self
     */
     ...
     * Sets next
     *
     * @param string|null $next Token to use to get to the next page
     *
     * @return self
     */
     ...
     * Sets prev
     *
     * @param string|null $prev Token to use to get to the previous page
     *
     * @return self
     */
