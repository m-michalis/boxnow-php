...
/**
 * ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost200Response Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_parcels__id__destinationlabel_generateUploadUrl_post_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('expiration_seconds', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['expiration_seconds'] === null) {
            $invalidProperties[] = "'expiration_seconds' can't be null";
        }
     ...
     * Sets upload_url
     *
     * @param string $upload_url Use this URL to upload label data, e.g. PDF
     *
     * @return self
     */
     ...
     *
     * @param float $expiration_seconds Number of seconds until the upload URL expires
     *
     * @return self
     */
    public function setExpirationSeconds($expiration_seconds)
    {
        if (is_null($expiration_seconds)) {
            throw new \InvalidArgumentException('non-nullable expiration_seconds cannot be null');
        }
