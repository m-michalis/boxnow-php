...
/**
 * ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1ParcelsIdDestinationlabelGenerateUploadUrlPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_parcels__id__destinationlabel_generateUploadUrl_post_request';
    ...
    protected static $attributeMap = [
        'destination_parcel_id' => 'destinationParcelId'
    ];
    ...
    protected static $setters = [
        'destination_parcel_id' => 'setDestinationParcelId'
    ];
    ...
    protected static $getters = [
        'destination_parcel_id' => 'getDestinationParcelId'
    ];
    ...
    {
        $this->setIfExists('destination_parcel_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['destination_parcel_id'] === null) {
            $invalidProperties[] = "'destination_parcel_id' can't be null";
        }
    ...
    /**
     * Gets destination_parcel_id
     *
     * @return string
     */
    public function getDestinationParcelId()
    {
        return $this->container['destination_parcel_id'];
    }

    /**
     * Sets destination_parcel_id
     *
     * @param string $destination_parcel_id Identifier of the parcel in the delivery partner system
     *
     * @return self
     */
    public function setDestinationParcelId($destination_parcel_id)
    {
        if (is_null($destination_parcel_id)) {
            throw new \InvalidArgumentException('non-nullable destination_parcel_id cannot be null');
        }
        $this->container['destination_parcel_id'] = $destination_parcel_id;
