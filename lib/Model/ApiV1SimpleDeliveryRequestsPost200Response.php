...
/**
 * ApiV1SimpleDeliveryRequestsPost200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1SimpleDeliveryRequestsPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_simple_delivery_requests_post_200_response';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'order_number' => 'string',
        'labels' => '\OpenAPI\Client\Model\LabelsInner[]',
        'parcels' => '\OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPost200ResponseParcelsInner[]'
    ];
    ...
    */
     ...
     * Sets order_number
     *
     * @param string $order_number Autogenerated order number. Use for subsequent requests to modify the order.
     *
     * @return self
     */
     ...
     * Gets labels
     *
     * @return \OpenAPI\Client\Model\LabelsInner[]
     */
     ...
     * Sets labels
     *
     * @param \OpenAPI\Client\Model\LabelsInner[] $labels labels
     *
     * @return self
     */
     ...
     * Gets parcels
     *
     * @return \OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPost200ResponseParcelsInner[]
     */
     ...
     * Sets parcels
     *
     * @param \OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPost200ResponseParcelsInner[] $parcels parcels
     *
     * @return self
     */
