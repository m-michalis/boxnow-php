...
/**
 * ApiV1SimpleDeliveryRequestsPost200ResponseParcelsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1SimpleDeliveryRequestsPost200ResponseParcelsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_simple_delivery_requests_post_200_response_parcels_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique parcel ID in our system
     *
     * @return self
     */
