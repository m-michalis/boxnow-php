...
/**
 * ApiV1SimpleDeliveryRequestsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1SimpleDeliveryRequestsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_simple_delivery_requests_post_request';
    ...
    protected static $openAPITypes = [
        'origin' => '\OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPostRequestOrigin',
        'destination' => '\OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPostRequestDestination',
        'payment_mode' => '\OpenAPI\Client\Model\PaymentMode',
        'amount_to_be_collected' => 'string',
        'allow_return' => 'bool',
        'parcel_size' => 'float',
        'parcels' => '\OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPostRequestParcelsInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('parcel_size', $data ?? [], null);
    ...
    */
     ...
     * Gets origin
     *
     * @return \OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPostRequestOrigin
     */
     ...
     * Sets origin
     *
     * @param \OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPostRequestOrigin $origin origin
     *
     * @return self
     */
     ...
     * Gets destination
     *
     * @return \OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPostRequestDestination
     */
     ...
     * Sets destination
     *
     * @param \OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPostRequestDestination $destination destination
     *
     * @return self
     */
     ...
     * Gets payment_mode
     *
     * @return \OpenAPI\Client\Model\PaymentMode|null
     */
     ...
     * Sets payment_mode
     *
     * @param \OpenAPI\Client\Model\PaymentMode|null $payment_mode payment_mode
     *
     * @return self
     */
     ...
     *
     * @param string|null $amount_to_be_collected COD amount for COD payment mode. Must only contain numbers with no more than one decimal point and exactly 2 decimal places.
     *
     * @return self
     */
    ...
    {
        return $this->container['parcel_size'];
    }

    /**
     * Sets parcel_size
     *
     * @param float|null $parcel_size Package size 1, 2, 3. Mandatory for delivery to AnyAPM. Default for created parcels, but can be overriden on parcel level for individual parcels.
     *
     * @return self
     */
    public function setParcelSize($parcel_size)
    {
        if (is_null($parcel_size)) {
            throw new \InvalidArgumentException('non-nullable parcel_size cannot be null');
        }
        $this->container['parcel_size'] = $parcel_size;
     ...
     * Gets parcels
     *
     * @return \OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPostRequestParcelsInner[]|null
     */
     ...
     * Sets parcels
     *
     * @param \OpenAPI\Client\Model\ApiV1SimpleDeliveryRequestsPostRequestParcelsInner[]|null $parcels Use to give us more info about the parcels. If not defined, one parcel is automatically created.
     *
     * @return self
     */
