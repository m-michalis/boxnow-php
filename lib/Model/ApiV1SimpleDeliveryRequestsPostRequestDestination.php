...
/**
 * ApiV1SimpleDeliveryRequestsPostRequestDestination Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1SimpleDeliveryRequestsPostRequestDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_simple_delivery_requests_post_request_destination';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['contact_phone_number'] === null) {
            $invalidProperties[] = "'contact_phone_number' can't be null";
        }
     ...
     *
     * @param string $contact_phone_number Phone number in international format
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Destination location ID, see /destinations for available IDs
     *
     * @return self
     */
