...
/**
 * ApiV1SimpleDeliveryRequestsPostRequestOrigin Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1SimpleDeliveryRequestsPostRequestOrigin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_simple_delivery_requests_post_request_origin';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Origin location code. Contact BoxNow support to obtain list of available codes.
     *
     * @return self
     */
