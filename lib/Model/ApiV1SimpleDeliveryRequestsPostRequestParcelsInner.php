...
/**
 * ApiV1SimpleDeliveryRequestsPostRequestParcelsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1SimpleDeliveryRequestsPostRequestParcelsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_simple_delivery_requests_post_request_parcels_inner';
    ...
    protected static $openAPITypes = [
        ...
        'weight' => 'float',
        'size' => 'float',
        'origin_delivery_parcel_id' => 'string',
        'destination_delivery_parcel_id' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'weight' => null,
        'size' => null,
        'origin_delivery_parcel_id' => null,
        'destination_delivery_parcel_id' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'weight' => false,
		'size' => false,
		'origin_delivery_parcel_id' => false,
		'destination_delivery_parcel_id' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'weight' => 'weight',
        'size' => 'size',
        'origin_delivery_parcel_id' => 'originDeliveryParcelId',
        'destination_delivery_parcel_id' => 'destinationDeliveryParcelId'
    ];
    ...
    protected static $setters = [
        ...
        'weight' => 'setWeight',
        'size' => 'setSize',
        'origin_delivery_parcel_id' => 'setOriginDeliveryParcelId',
        'destination_delivery_parcel_id' => 'setDestinationDeliveryParcelId'
    ];
    ...
    protected static $getters = [
        ...
        'weight' => 'getWeight',
        'size' => 'getSize',
        'origin_delivery_parcel_id' => 'getOriginDeliveryParcelId',
        'destination_delivery_parcel_id' => 'getDestinationDeliveryParcelId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('value', $data ?? [], '0.00');
        $this->setIfExists('weight', $data ?? [], null);
        $this->setIfExists('size', $data ?? [], null);
        $this->setIfExists('origin_delivery_parcel_id', $data ?? [], null);
        $this->setIfExists('destination_delivery_parcel_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Reference number in Your system
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Contents name label
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Item value. Must only contain numbers with no more than one decimal point and exactly 2 decimal places.
     *
     * @return self
     */
     ...
     * Sets weight
     *
     * @param float|null $weight Item weight in kg
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param float|null $size Compartment size required for the package. Required for `any-apm` origin.
     *
     * @return self
     */
    ...
    /**
     * Gets origin_delivery_parcel_id
     *
     * @return string|null
     */
    public function getOriginDeliveryParcelId()
    {
        return $this->container['origin_delivery_parcel_id'];
    }

    /**
     * Sets origin_delivery_parcel_id
     *
     * @param string|null $origin_delivery_parcel_id Parcel id of 3rd party delivery service. Fill in in case you are using other delivery service to deliver us the order.
     *
     * @return self
     */
    public function setOriginDeliveryParcelId($origin_delivery_parcel_id)
    {
        if (is_null($origin_delivery_parcel_id)) {
            throw new \InvalidArgumentException('non-nullable origin_delivery_parcel_id cannot be null');
        }
        $this->container['origin_delivery_parcel_id'] = $origin_delivery_parcel_id;

        return $this;
    }

    /**
     * Gets destination_delivery_parcel_id
     *
     * @return string|null
     */
    public function getDestinationDeliveryParcelId()
    {
        return $this->container['destination_delivery_parcel_id'];
    }

    /**
     * Sets destination_delivery_parcel_id
     *
     * @param string|null $destination_delivery_parcel_id Parcel id of 3rd party delivery service. Fill in in case you are using other delivery service for final delivery.
     *
     * @return self
     */
    public function setDestinationDeliveryParcelId($destination_delivery_parcel_id)
    {
        if (is_null($destination_delivery_parcel_id)) {
            throw new \InvalidArgumentException('non-nullable destination_delivery_parcel_id cannot be null');
        }
        $this->container['destination_delivery_parcel_id'] = $destination_delivery_parcel_id;
