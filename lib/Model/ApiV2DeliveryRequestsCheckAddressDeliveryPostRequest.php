...
/**
 * ApiV2DeliveryRequestsCheckAddressDeliveryPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2DeliveryRequestsCheckAddressDeliveryPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v2_delivery_requests_checkAddressDelivery_post_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('zip_precision', $data ?? [], true);
    }
    ...
    */
     ...
     * Sets street
     *
     * @param string|null $street Street and street number
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string $postal_code Postal code of the location. If set, must include only numbers
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string $region BCP 47 language tag format
     *
     * @return self
     */
     ...
     * Sets radius
     *
     * @param float|null $radius Radius in meters. Location must be in this radius from the input address.
     *
     * @return self
     */
     ...
     *
     * @param float|null $compartment_size Compartment size required for the package.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getZipPrecision()
    {
        return $this->container['zip_precision'];
    }

    /**
     * Sets zip_precision
     *
     * @param bool|null $zip_precision Enhances address accuracy by validating the provided postal code.  When set to `true`, the service ensures precise address matching by cross-referencing  the input ZIP code with potential matches.
     *
     * @return self
     */
    public function setZipPrecision($zip_precision)
    {
        if (is_null($zip_precision)) {
            throw new \InvalidArgumentException('non-nullable zip_precision cannot be null');
        }
        $this->container['zip_precision'] = $zip_precision;
