...
class DeliveryPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'mode' => '\OpenAPI\Client\Model\PaymentMode',
        'price' => '\OpenAPI\Client\Model\Money',
        'state' => '\OpenAPI\Client\Model\PaymentState'
    ];
    ...
    */
     ...
     * Sets mode
     *
     * @param \OpenAPI\Client\Model\PaymentMode $mode mode
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Model\PaymentState
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\PaymentState $state state
     *
     * @return self
     */
