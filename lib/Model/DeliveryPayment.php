 ...
 */
class DeliveryPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryPayment';
    ...
    protected static $openAPITypes = [
        'mode' => '\Boxnow\Model\PaymentMode',
        'price' => '\Boxnow\Model\Money',
        'state' => '\Boxnow\Model\PaymentState'
    ];
    ...
    */
     ...
     * Sets mode
     *
     * @param \Boxnow\Model\PaymentMode $mode mode
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param \Boxnow\Model\Money $price price
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Boxnow\Model\PaymentState
     */
     ...
     * Sets state
     *
     * @param \Boxnow\Model\PaymentState $state state
     *
     * @return self
     */
