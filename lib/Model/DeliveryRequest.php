...
class DeliveryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'overwrite_sender_shipping_label_info' => '\Boxnow\Model\DeliveryRequestOverwriteSenderShippingLabelInfo',
        'type_of_service' => 'string',
        'description' => 'string',
        'order_number' => 'string',
        'invoice_value' => 'string',
        'payment_mode' => '\Boxnow\Model\PaymentMode',
        'amount_to_be_collected' => 'string',
        'allow_return' => 'bool',
        'show_recipient_information' => 'bool',
        'notify_on_accepted' => 'string',
        'notify_smson_accepted' => 'string',
        'additional_information' => 'string',
        'return_location' => '\Boxnow\Model\DeliveryRequestReturnLocation',
        'origin' => '\Boxnow\Model\DeliveryRequestOrigin',
        'destination' => '\Boxnow\Model\DeliveryRequestDestination',
        'items' => '\Boxnow\Model\DeliveryRequestItemsInner[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'allow_return' => null,
        'show_recipient_information' => null,
        'notify_on_accepted' => null,
        'notify_smson_accepted' => null,
    ...
    protected static array $openAPINullables = [
        'overwrite_sender_shipping_label_info' => false,
        ...
        'allow_return' => false,
        'show_recipient_information' => false,
        'notify_on_accepted' => false,
        'notify_smson_accepted' => false,
    ...
    protected static $attributeMap = [
        ...
        'show_recipient_information' => 'showRecipientInformation',
        'notify_on_accepted' => 'notifyOnAccepted',
        'notify_smson_accepted' => 'notifySMSOnAccepted',
    ...
    protected static $setters = [
        ...
        'show_recipient_information' => 'setShowRecipientInformation',
        'notify_on_accepted' => 'setNotifyOnAccepted',
        'notify_smson_accepted' => 'setNotifySmsonAccepted',
    ...
    protected static $getters = [
        ...
        'show_recipient_information' => 'getShowRecipientInformation',
        'notify_on_accepted' => 'getNotifyOnAccepted',
        'notify_smson_accepted' => 'getNotifySmsonAccepted',
    ...
    {
        $this->setIfExists('overwrite_sender_shipping_label_info', $data ?? [], null);
        ...
        $this->setIfExists('show_recipient_information', $data ?? [], null);
        $this->setIfExists('notify_on_accepted', $data ?? [], null);
        $this->setIfExists('notify_smson_accepted', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \Boxnow\Model\DeliveryRequestOverwriteSenderShippingLabelInfo|null
     */
     ...
     *
     * @param \Boxnow\Model\DeliveryRequestOverwriteSenderShippingLabelInfo|null $overwrite_sender_shipping_label_info overwrite_sender_shipping_label_info
     *
     * @return self
     */
    public function setOverwriteSenderShippingLabelInfo($overwrite_sender_shipping_label_info)
    {
        if (is_null($overwrite_sender_shipping_label_info)) {
            throw new \InvalidArgumentException('non-nullable overwrite_sender_shipping_label_info cannot be null');
        }
     ...
     *
     * @param string|null $type_of_service Type of delivery service. You may not be eligible to use all types of service, contact support for further information.
     *
     * @return self
     */
     ...
     * Gets payment_mode
     *
     * @return \Boxnow\Model\PaymentMode
     */
     ...
     * Sets payment_mode
     *
     * @param \Boxnow\Model\PaymentMode $payment_mode payment_mode
     *
     * @return self
     */
     ...
     * Sets allow_return
     *
     * @param bool|null $allow_return If true, client will be able to return the goods the same way he received it.
     *
     * @return self
     */
    ...
    /**
     * Gets show_recipient_information
     *
     * @return bool|null
     */
    public function getShowRecipientInformation()
    {
        return $this->container['show_recipient_information'];
    }

    /**
     * Sets show_recipient_information
     *
     * @param bool|null $show_recipient_information If true, recipient phone number and email will be printed on the label.
     *
     * @return self
     */
    public function setShowRecipientInformation($show_recipient_information)
    {
        if (is_null($show_recipient_information)) {
            throw new \InvalidArgumentException('non-nullable show_recipient_information cannot be null');
        }
        $this->container['show_recipient_information'] = $show_recipient_information;
     ...
     *
     * @param string|null $notify_on_accepted If set, we send a notification to this email when we accepted the order to our system.
     *
     * @return self
     */
    ...
    /**
     * Gets notify_smson_accepted
     *
     * @return string|null
     */
    public function getNotifySmsonAccepted()
    {
        return $this->container['notify_smson_accepted'];
    }

    /**
     * Sets notify_smson_accepted
     *
     * @param string|null $notify_smson_accepted Phone number in international format. If set, we send a sms notification to this phone number.
     *
     * @return self
     */
    public function setNotifySmsonAccepted($notify_smson_accepted)
    {
        if (is_null($notify_smson_accepted)) {
            throw new \InvalidArgumentException('non-nullable notify_smson_accepted cannot be null');
        }
        $this->container['notify_smson_accepted'] = $notify_smson_accepted;
     ...
     *
     * @param string|null $additional_information Additional delivery request information. This is later send through the webhook
     *
     * @return self
     */
     ...
     *
     * @return \Boxnow\Model\DeliveryRequestReturnLocation|null
     */
     ...
     *
     * @param \Boxnow\Model\DeliveryRequestReturnLocation|null $return_location return_location
     *
     * @return self
     */
     ...
     * Gets origin
     *
     * @return \Boxnow\Model\DeliveryRequestOrigin
     */
     ...
     * Sets origin
     *
     * @param \Boxnow\Model\DeliveryRequestOrigin $origin origin
     *
     * @return self
     */
     ...
     * Gets destination
     *
     * @return \Boxnow\Model\DeliveryRequestDestination
     */
     ...
     * Sets destination
     *
     * @param \Boxnow\Model\DeliveryRequestDestination $destination destination
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \Boxnow\Model\DeliveryRequestItemsInner[]
     */
     ...
     * Sets items
     *
     * @param \Boxnow\Model\DeliveryRequestItemsInner[] $items List of parcels you want to send via BoxNow.
     *
     * @return self
     */
