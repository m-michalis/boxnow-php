...
/**
 * DeliveryRequestItemsInner Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryRequestItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryRequest_items_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Item reference number in Your system
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Order item name (maximum 1000 characters)
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Item value. Must only contain numbers with no more than one decimal point and exactly 2 decimal places.
     *
     * @return self
     */
     ...
     *
     * @param float|null $compartment_size Compartment size required for the package. Required only for `apm`/`any-apm` origin.
     *
     * @return self
     */
