...
/**
 * DeliveryRequestOriginAllOf Class Doc Comment
 *
 * @category Class
 ...
 */
class DeliveryRequestOriginAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryRequest_origin_allOf';
