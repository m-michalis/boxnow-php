...
/**
 * DeliveryRequestReturnLocation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryRequestReturnLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryRequest_returnLocation';
    ...
    */
     ...
     * Sets location_id
     *
     * @param string $location_id Warehouse Location ID from `/origins` endpoint
     *
     * @return self
     */
