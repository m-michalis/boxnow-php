...
class DeliveryRequestV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'origin' => '\Boxnow\Model\DeliveryRequestV2Origin',
        'destination' => '\Boxnow\Model\DeliveryRequestV2Destination',
        'parcels' => '\Boxnow\Model\DeliveryRequestV2ParcelsInner[]'
    ];
    ...
    */
     ...
     * Gets origin
     *
     * @return \Boxnow\Model\DeliveryRequestV2Origin
     */
     ...
     * Sets origin
     *
     * @param \Boxnow\Model\DeliveryRequestV2Origin $origin origin
     *
     * @return self
     */
     ...
     * Gets destination
     *
     * @return \Boxnow\Model\DeliveryRequestV2Destination
     */
     ...
     * Sets destination
     *
     * @param \Boxnow\Model\DeliveryRequestV2Destination $destination destination
     *
     * @return self
     */
     ...
     * Gets parcels
     *
     * @return \Boxnow\Model\DeliveryRequestV2ParcelsInner[]
     */
     ...
     * Sets parcels
     *
     * @param \Boxnow\Model\DeliveryRequestV2ParcelsInner[] $parcels List of parcels you want to send via BoxNow.
     *
     * @return self
     */
