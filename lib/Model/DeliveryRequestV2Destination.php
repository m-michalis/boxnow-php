...
/**
 * DeliveryRequestV2Destination Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryRequestV2Destination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryRequestV2_destination';
    ...
    protected static $setters = [
        ...
        'delivery_partner_id' => 'setDeliveryPartnerId',
        'title' => 'setTitle',
        'name' => 'setName',
    ...
    protected static $getters = [
        ...
        'delivery_partner_id' => 'getDeliveryPartnerId',
        'title' => 'getTitle',
        'name' => 'getName',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('delivery_partner_id', $data ?? [], null);
    ...
    */
     ...
     * Sets contact_number
     *
     * @param string $contact_number Phone number
     *
     * @return self
     */
     ...
     * Sets contact_email
     *
     * @param string $contact_email E-mail address
     *
     * @return self
     */
     ...
     * Sets contact_name
     *
     * @param string $contact_name Name, e.g. person or company name
     *
     * @return self
     */
    ...
    /**
     * Gets delivery_partner_id
     *
     * @return string|null
     */
    public function getDeliveryPartnerId()
    {
        return $this->container['delivery_partner_id'];
    }

    /**
     * Sets delivery_partner_id
     *
     * @param string|null $delivery_partner_id Use if want to deliver the parcels via another delivery service. ID of Delivery partner, see `/delivery-partners`
     *
     * @return self
     */
    public function setDeliveryPartnerId($delivery_partner_id)
    {
        if (is_null($delivery_partner_id)) {
            throw new \InvalidArgumentException('non-nullable delivery_partner_id cannot be null');
        }
        $this->container['delivery_partner_id'] = $delivery_partner_id;
     ...
     * Sets id
     *
     * @param string $id Location ID from `/destinations` endpoint
     *
     * @return self
     */
