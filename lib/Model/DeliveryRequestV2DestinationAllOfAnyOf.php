...
/**
 * DeliveryRequestV2DestinationAllOfAnyOf Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryRequestV2DestinationAllOfAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryRequestV2_destination_allOf_anyOf';
