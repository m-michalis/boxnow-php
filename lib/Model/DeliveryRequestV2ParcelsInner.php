...
/**
 * DeliveryRequestV2ParcelsInner Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryRequestV2ParcelsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryRequestV2_parcels_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Parcel reference number in Your system
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Order item name
     *
     * @return self
     */
