 ...
 */
class EventsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Events_inner';
    ...
    public const TYPE_IN_DEPOT = 'in-depot';
    public const TYPE_FINAL_DESTINATION = 'final-destination';
    public const TYPE_CANCELED = 'canceled';
    public const TYPE_ACCEPTED_FOR_RETURN = 'accepted-for-return';
    public const TYPE_MISSING = 'missing';
    public const TYPE_ACCEPTED_TO_LOCKER = 'accepted-to-locker';
    ...
    */
     ...
     *
     * @param string|null $location_display_name Event source location
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Event source location postal code
     *
     * @return self
     */
