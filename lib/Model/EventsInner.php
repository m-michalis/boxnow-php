...
class EventsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets type
     *
     * @param \Boxnow\Model\EventType $type type
     *
     * @return self
     */
     ...
     * Sets location_id
     *
     * @param string|null $location_id Event source location ID
     *
     * @return self
     */
     ...
     * Sets create_time
     *
     * @param \DateTimeMixed $create_time create_time
     *
     * @return self
     */
