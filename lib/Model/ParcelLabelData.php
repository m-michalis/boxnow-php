...
class ParcelLabelData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'parcel' => '\Boxnow\Model\ParcelLabelDataParcel',
        'partner_name' => 'string',
        'depot_display_name' => 'string',
        'lane_display_name' => 'string',
        'sender' => '\Boxnow\Model\ParcelLabelDataSender',
        'recipient' => '\Boxnow\Model\ParcelLabelDataRecipient',
        'delivery' => '\Boxnow\Model\ParcelLabelDataDelivery',
        'payment' => '\Boxnow\Model\ParcelLabelDataPayment',
        'create_time' => 'string',
        'order_number' => 'string'
    ];
    ...
    */
     ...
     * Gets parcel
     *
     * @return \Boxnow\Model\ParcelLabelDataParcel
     */
     ...
     * Sets parcel
     *
     * @param \Boxnow\Model\ParcelLabelDataParcel $parcel parcel
     *
     * @return self
     */
     ...
     * Gets sender
     *
     * @return \Boxnow\Model\ParcelLabelDataSender
     */
     ...
     * Sets sender
     *
     * @param \Boxnow\Model\ParcelLabelDataSender $sender sender
     *
     * @return self
     */
     ...
     * Gets recipient
     *
     * @return \Boxnow\Model\ParcelLabelDataRecipient
     */
     ...
     * Sets recipient
     *
     * @param \Boxnow\Model\ParcelLabelDataRecipient $recipient recipient
     *
     * @return self
     */
     ...
     * Gets delivery
     *
     * @return \Boxnow\Model\ParcelLabelDataDelivery
     */
     ...
     * Sets delivery
     *
     * @param \Boxnow\Model\ParcelLabelDataDelivery $delivery delivery
     *
     * @return self
     */
     ...
     * Gets payment
     *
     * @return \Boxnow\Model\ParcelLabelDataPayment
     */
     ...
     * Sets payment
     *
     * @param \Boxnow\Model\ParcelLabelDataPayment $payment payment
     *
     * @return self
     */
     ...
     * Sets create_time
     *
     * @param string|null $create_time Date time in 24h format based on region, e.g. `Τετ 21/12/22 16:37` for `el-GR` region.
     *
     * @return self
     */
