...
/**
 * ParcelLabelData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ParcelLabelData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParcelLabelData';
    ...
    protected static $openAPITypes = [
        'parcel' => '\OpenAPI\Client\Model\ParcelLabelDataParcel',
        'partner_name' => 'string',
        'depot_display_name' => 'string',
        'lane_display_name' => 'string',
        'sender' => '\OpenAPI\Client\Model\ParcelLabelDataSender',
        'recipient' => '\OpenAPI\Client\Model\ParcelLabelDataRecipient',
        'delivery' => '\OpenAPI\Client\Model\ParcelLabelDataDelivery',
        'payment' => '\OpenAPI\Client\Model\ParcelLabelDataPayment',
        'create_time' => 'string',
        'order_number' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'parcel' => null,
        'partner_name' => null,
        'depot_display_name' => null,
        'lane_display_name' => null,
        'sender' => null,
        'recipient' => null,
        'delivery' => null,
        'payment' => null,
    ...
    protected static array $openAPINullables = [
        'parcel' => false,
		'partner_name' => false,
		'depot_display_name' => false,
		'lane_display_name' => false,
		'sender' => false,
		'recipient' => false,
		'delivery' => false,
		'payment' => false,
    ...
    protected static $attributeMap = [
        ...
        'depot_display_name' => 'depotDisplayName',
    ...
    protected static $setters = [
        ...
        'depot_display_name' => 'setDepotDisplayName',
        'lane_display_name' => 'setLaneDisplayName',
        'sender' => 'setSender',
    ...
    protected static $getters = [
        ...
        'depot_display_name' => 'getDepotDisplayName',
        'lane_display_name' => 'getLaneDisplayName',
        'sender' => 'getSender',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('depot_display_name', $data ?? [], null);
        $this->setIfExists('lane_display_name', $data ?? [], null);
    ...
    */
     ...
     * Gets parcel
     *
     * @return \OpenAPI\Client\Model\ParcelLabelDataParcel
     */
     ...
     * Sets parcel
     *
     * @param \OpenAPI\Client\Model\ParcelLabelDataParcel $parcel parcel
     *
     * @return self
     */
    ...
    /**
     * Gets depot_display_name
     *
     * @return string|null
     */
    public function getDepotDisplayName()
    {
        return $this->container['depot_display_name'];
    }

    /**
     * Sets depot_display_name
     *
     * @param string|null $depot_display_name depot_display_name
     *
     * @return self
     */
    public function setDepotDisplayName($depot_display_name)
    {
        if (is_null($depot_display_name)) {
            throw new \InvalidArgumentException('non-nullable depot_display_name cannot be null');
        }
        $this->container['depot_display_name'] = $depot_display_name;

        return $this;
    }

    /**
     * Gets lane_display_name
     *
     * @return string|null
     */
    public function getLaneDisplayName()
    {
        return $this->container['lane_display_name'];
    }

    /**
     * Sets lane_display_name
     *
     * @param string|null $lane_display_name lane_display_name
     *
     * @return self
     */
    public function setLaneDisplayName($lane_display_name)
    {
        if (is_null($lane_display_name)) {
            throw new \InvalidArgumentException('non-nullable lane_display_name cannot be null');
        }
        $this->container['lane_display_name'] = $lane_display_name;
     ...
     * Gets sender
     *
     * @return \OpenAPI\Client\Model\ParcelLabelDataSender
     */
     ...
     * Sets sender
     *
     * @param \OpenAPI\Client\Model\ParcelLabelDataSender $sender sender
     *
     * @return self
     */
     ...
     * Gets recipient
     *
     * @return \OpenAPI\Client\Model\ParcelLabelDataRecipient
     */
     ...
     * Sets recipient
     *
     * @param \OpenAPI\Client\Model\ParcelLabelDataRecipient $recipient recipient
     *
     * @return self
     */
     ...
     * Gets delivery
     *
     * @return \OpenAPI\Client\Model\ParcelLabelDataDelivery
     */
     ...
     * Sets delivery
     *
     * @param \OpenAPI\Client\Model\ParcelLabelDataDelivery $delivery delivery
     *
     * @return self
     */
     ...
     * Gets payment
     *
     * @return \OpenAPI\Client\Model\ParcelLabelDataPayment
     */
     ...
     * Sets payment
     *
     * @param \OpenAPI\Client\Model\ParcelLabelDataPayment $payment payment
     *
     * @return self
     */
     ...
     * Sets create_time
     *
     * @param string|null $create_time Date time in `en-GB` 24h format, e.g. `Mon 25/07/22 16:14`
     *
     * @return self
     */
