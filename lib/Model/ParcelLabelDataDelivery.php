...
/**
 * ParcelLabelDataDelivery Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ParcelLabelDataDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParcelLabelData_delivery';
    ...
    protected static $openAPIFormats = [
        ...
        'city' => null,
        'zip' => null,
        'destination_public_id' => null,
        'last_stop_order' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'city' => false,
        'zip' => false,
        'destination_public_id' => false,
        'last_stop_order' => false,
        'delivery_partner_name' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'city' => 'city',
        'zip' => 'zip',
        'destination_public_id' => 'destinationPublicId',
        'last_stop_order' => 'lastStopOrder',
    ...
    protected static $setters = [
        ...
        'city' => 'setCity',
        'zip' => 'setZip',
        'destination_public_id' => 'setDestinationPublicId',
        'last_stop_order' => 'setLastStopOrder',
        'delivery_partner_name' => 'setDeliveryPartnerName'
    ];
    ...
    protected static $getters = [
        ...
        'city' => 'getCity',
        'zip' => 'getZip',
        'destination_public_id' => 'getDestinationPublicId',
        'last_stop_order' => 'getLastStopOrder',
        'delivery_partner_name' => 'getDeliveryPartnerName'
    ];
    ...
    public const TYPE_APM_DELIVERY = 'apm-delivery';
    public const TYPE_DELIVERY_PARTNER_DELIVERY = 'delivery-partner-delivery';
    ...
    {
        return [
            self::TYPE_APM_DELIVERY,
            self::TYPE_DELIVERY_PARTNER_DELIVERY,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('destination_public_id', $data ?? [], null);
        $this->setIfExists('last_stop_order', $data ?? [], null);
        $this->setIfExists('delivery_partner_name', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['destination_public_id'] === null) {
            $invalidProperties[] = "'destination_public_id' can't be null";
        }
        if ($this->container['delivery_partner_name'] === null) {
            $invalidProperties[] = "'delivery_partner_name' can't be null";
        }
    ...
    /**
     * Gets destination_public_id
     *
     * @return string
     */
    public function getDestinationPublicId()
    {
        return $this->container['destination_public_id'];
    }

    /**
     * Sets destination_public_id
     *
     * @param string $destination_public_id destination_public_id
     *
     * @return self
     */
    public function setDestinationPublicId($destination_public_id)
    {
        if (is_null($destination_public_id)) {
            throw new \InvalidArgumentException('non-nullable destination_public_id cannot be null');
        }
        $this->container['destination_public_id'] = $destination_public_id;

        return $this;
    }

    /**
     * Gets last_stop_order
     *
     * @return float|null
     */
    public function getLastStopOrder()
    {
        return $this->container['last_stop_order'];
    }

    /**
     * Sets last_stop_order
     *
     * @param float|null $last_stop_order last_stop_order
     *
     * @return self
     */
    public function setLastStopOrder($last_stop_order)
    {
        if (is_null($last_stop_order)) {
            throw new \InvalidArgumentException('non-nullable last_stop_order cannot be null');
        }
        $this->container['last_stop_order'] = $last_stop_order;

        return $this;
    }

    /**
     * Gets delivery_partner_name
     *
     * @return string
     */
    public function getDeliveryPartnerName()
    {
        return $this->container['delivery_partner_name'];
    }

    /**
     * Sets delivery_partner_name
     *
     * @param string $delivery_partner_name delivery_partner_name
     *
     * @return self
     */
    public function setDeliveryPartnerName($delivery_partner_name)
    {
        if (is_null($delivery_partner_name)) {
            throw new \InvalidArgumentException('non-nullable delivery_partner_name cannot be null');
        }
        $this->container['delivery_partner_name'] = $delivery_partner_name;
