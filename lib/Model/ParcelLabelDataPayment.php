...
/**
 * ParcelLabelDataPayment Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ParcelLabelDataPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParcelLabelData_payment';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('parcel_count', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['parcel_count'] === null) {
            $invalidProperties[] = "'parcel_count' can't be null";
        }
    ...
    {
        return $this->container['parcel_count'];
    }

    /**
     * Sets parcel_count
     *
     * @param float $parcel_count parcel_count
     *
     * @return self
     */
    public function setParcelCount($parcel_count)
    {
        if (is_null($parcel_count)) {
            throw new \InvalidArgumentException('non-nullable parcel_count cannot be null');
        }
        $this->container['parcel_count'] = $parcel_count;
