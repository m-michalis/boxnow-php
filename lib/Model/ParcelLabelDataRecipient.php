...
/**
 * ParcelLabelDataRecipient Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ParcelLabelDataRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParcelLabelData_recipient';
    ...
    protected static $attributeMap = [
        'raw_info' => 'rawInfo',
        'type' => 'type',
        'shipping_label_info' => 'shippingLabelInfo',
        'name' => 'name',
    ...
    protected static $setters = [
        'raw_info' => 'setRawInfo',
        'type' => 'setType',
        'shipping_label_info' => 'setShippingLabelInfo',
        'name' => 'setName',
    ...
    protected static $getters = [
        'raw_info' => 'getRawInfo',
        'type' => 'getType',
        'shipping_label_info' => 'getShippingLabelInfo',
        'name' => 'getName',
    ...
    {
        $this->setIfExists('raw_info', $data ?? [], null);
        $this->setIfExists('type', $data ?? [], null);
        $this->setIfExists('shipping_label_info', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['raw_info'] === null) {
            $invalidProperties[] = "'raw_info' can't be null";
        }
        ...
        if ($this->container['shipping_label_info'] === null) {
            $invalidProperties[] = "'shipping_label_info' can't be null";
        }
    ...
    {
        return $this->container['raw_info'];
    }

    /**
     * Sets raw_info
     *
     * @param string $raw_info Recipient's raw information for the shipping label
     *
     * @return self
     */
    public function setRawInfo($raw_info)
    {
        if (is_null($raw_info)) {
            throw new \InvalidArgumentException('non-nullable raw_info cannot be null');
        }
        $this->container['raw_info'] = $raw_info;
    ...
    /**
     * Gets shipping_label_info
     *
     * @return string
     */
    public function getShippingLabelInfo()
    {
        return $this->container['shipping_label_info'];
    }

    /**
     * Sets shipping_label_info
     *
     * @param string $shipping_label_info shipping_label_info
     *
     * @return self
     */
    public function setShippingLabelInfo($shipping_label_info)
    {
        if (is_null($shipping_label_info)) {
            throw new \InvalidArgumentException('non-nullable shipping_label_info cannot be null');
        }
        $this->container['shipping_label_info'] = $shipping_label_info;
