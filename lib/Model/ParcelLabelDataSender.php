...
/**
 * ParcelLabelDataSender Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class ParcelLabelDataSender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParcelLabelData_sender';
    ...
    */
     ...
     * Sets raw_info
     *
     * @param string $raw_info Sender's raw information for the shipping label
     *
     * @return self
     */
