...
/**
 * PartnerPermission Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class PartnerPermission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerPermission';
    ...
    protected static $openAPITypes = [
        'depot_as_origin' => 'bool',
        'warehouse_as_origin' => 'bool',
        'any_apm_as_origin' => 'bool',
        'any_apm_to_same_apm_delivery' => 'bool',
        'any_apm_to_same_apm_delivery_without_confirmation' => 'bool',
        'custom_form' => 'bool',
        'cod_payment' => 'bool',
        'can_customer_create_customer_returns' => 'bool',
        'can_partner_create_customer_returns' => 'bool',
        'address_as_destination' => 'bool',
        'cod_address_as_destination' => 'bool',
        'larger_compartment_while_sending' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'depot_as_origin' => null,
        'warehouse_as_origin' => null,
        'any_apm_as_origin' => null,
        'any_apm_to_same_apm_delivery' => null,
        'any_apm_to_same_apm_delivery_without_confirmation' => null,
        'custom_form' => null,
        'cod_payment' => null,
        'can_customer_create_customer_returns' => null,
        'can_partner_create_customer_returns' => null,
        'address_as_destination' => null,
        'cod_address_as_destination' => null,
        'larger_compartment_while_sending' => null
    ];
    ...
    protected static array $openAPINullables = [
        'depot_as_origin' => false,
        'warehouse_as_origin' => false,
        'any_apm_as_origin' => false,
        'any_apm_to_same_apm_delivery' => false,
        'any_apm_to_same_apm_delivery_without_confirmation' => false,
        'custom_form' => false,
        'cod_payment' => false,
        'can_customer_create_customer_returns' => false,
        'can_partner_create_customer_returns' => false,
        'address_as_destination' => false,
        'cod_address_as_destination' => false,
        'larger_compartment_while_sending' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'can_customer_create_customer_returns' => 'canCustomerCreateCustomerReturns',
        'can_partner_create_customer_returns' => 'canPartnerCreateCustomerReturns',
        'address_as_destination' => 'addressAsDestination',
        'cod_address_as_destination' => 'codAddressAsDestination',
        'larger_compartment_while_sending' => 'largerCompartmentWhileSending'
    ];
    ...
    protected static $setters = [
        'depot_as_origin' => 'setDepotAsOrigin',
        'warehouse_as_origin' => 'setWarehouseAsOrigin',
        'any_apm_as_origin' => 'setAnyApmAsOrigin',
        'any_apm_to_same_apm_delivery' => 'setAnyApmToSameApmDelivery',
        'any_apm_to_same_apm_delivery_without_confirmation' => 'setAnyApmToSameApmDeliveryWithoutConfirmation',
        'custom_form' => 'setCustomForm',
        'cod_payment' => 'setCodPayment',
        'can_customer_create_customer_returns' => 'setCanCustomerCreateCustomerReturns',
        'can_partner_create_customer_returns' => 'setCanPartnerCreateCustomerReturns',
        'address_as_destination' => 'setAddressAsDestination',
        'cod_address_as_destination' => 'setCodAddressAsDestination',
        'larger_compartment_while_sending' => 'setLargerCompartmentWhileSending'
    ];
    ...
    protected static $getters = [
        'depot_as_origin' => 'getDepotAsOrigin',
        'warehouse_as_origin' => 'getWarehouseAsOrigin',
        'any_apm_as_origin' => 'getAnyApmAsOrigin',
        'any_apm_to_same_apm_delivery' => 'getAnyApmToSameApmDelivery',
        'any_apm_to_same_apm_delivery_without_confirmation' => 'getAnyApmToSameApmDeliveryWithoutConfirmation',
        'custom_form' => 'getCustomForm',
        'cod_payment' => 'getCodPayment',
        'can_customer_create_customer_returns' => 'getCanCustomerCreateCustomerReturns',
        'can_partner_create_customer_returns' => 'getCanPartnerCreateCustomerReturns',
        'address_as_destination' => 'getAddressAsDestination',
        'cod_address_as_destination' => 'getCodAddressAsDestination',
        'larger_compartment_while_sending' => 'getLargerCompartmentWhileSending'
    ];
    ...
    {
        $this->setIfExists('depot_as_origin', $data ?? [], null);
        $this->setIfExists('warehouse_as_origin', $data ?? [], null);
        $this->setIfExists('any_apm_as_origin', $data ?? [], null);
        $this->setIfExists('any_apm_to_same_apm_delivery', $data ?? [], null);
        $this->setIfExists('any_apm_to_same_apm_delivery_without_confirmation', $data ?? [], null);
        $this->setIfExists('custom_form', $data ?? [], null);
        $this->setIfExists('cod_payment', $data ?? [], null);
        $this->setIfExists('can_customer_create_customer_returns', $data ?? [], null);
        $this->setIfExists('can_partner_create_customer_returns', $data ?? [], null);
        $this->setIfExists('address_as_destination', $data ?? [], null);
        $this->setIfExists('cod_address_as_destination', $data ?? [], null);
        $this->setIfExists('larger_compartment_while_sending', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets depot_as_origin
     *
     * @return bool|null
     */
    public function getDepotAsOrigin()
    {
        return $this->container['depot_as_origin'];
    }

    /**
     * Sets depot_as_origin
     *
     * @param bool|null $depot_as_origin Can use Depot as origin - yes / no
     *
     * @return self
     */
    public function setDepotAsOrigin($depot_as_origin)
    {
        if (is_null($depot_as_origin)) {
            throw new \InvalidArgumentException('non-nullable depot_as_origin cannot be null');
        }
        $this->container['depot_as_origin'] = $depot_as_origin;

        return $this;
    }

    /**
     * Gets warehouse_as_origin
     *
     * @return bool|null
     */
    public function getWarehouseAsOrigin()
    {
        return $this->container['warehouse_as_origin'];
    }

    /**
     * Sets warehouse_as_origin
     *
     * @param bool|null $warehouse_as_origin Can use Warehouse as origin - yes / no
     *
     * @return self
     */
    public function setWarehouseAsOrigin($warehouse_as_origin)
    {
        if (is_null($warehouse_as_origin)) {
            throw new \InvalidArgumentException('non-nullable warehouse_as_origin cannot be null');
        }
        $this->container['warehouse_as_origin'] = $warehouse_as_origin;

        return $this;
    }

    /**
     * Gets any_apm_as_origin
     *
     * @return bool|null
     */
    public function getAnyApmAsOrigin()
    {
        return $this->container['any_apm_as_origin'];
    }

    /**
     * Sets any_apm_as_origin
     *
     * @param bool|null $any_apm_as_origin Can use AnyAPM as origin - yes / no
     *
     * @return self
     */
    public function setAnyApmAsOrigin($any_apm_as_origin)
    {
        if (is_null($any_apm_as_origin)) {
            throw new \InvalidArgumentException('non-nullable any_apm_as_origin cannot be null');
        }
        $this->container['any_apm_as_origin'] = $any_apm_as_origin;

        return $this;
    }

    /**
     * Gets any_apm_to_same_apm_delivery
     *
     * @return bool|null
     */
    public function getAnyApmToSameApmDelivery()
    {
        return $this->container['any_apm_to_same_apm_delivery'];
    }

    /**
     * Sets any_apm_to_same_apm_delivery
     *
     * @param bool|null $any_apm_to_same_apm_delivery Can use AnyAPM to the same APM delivery - yes / no
     *
     * @return self
     */
    public function setAnyApmToSameApmDelivery($any_apm_to_same_apm_delivery)
    {
        if (is_null($any_apm_to_same_apm_delivery)) {
            throw new \InvalidArgumentException('non-nullable any_apm_to_same_apm_delivery cannot be null');
        }
        $this->container['any_apm_to_same_apm_delivery'] = $any_apm_to_same_apm_delivery;

        return $this;
    }

    /**
     * Gets any_apm_to_same_apm_delivery_without_confirmation
     *
     * @return bool|null
     */
    public function getAnyApmToSameApmDeliveryWithoutConfirmation()
    {
        return $this->container['any_apm_to_same_apm_delivery_without_confirmation'];
    }

    /**
     * Sets any_apm_to_same_apm_delivery_without_confirmation
     *
     * @param bool|null $any_apm_to_same_apm_delivery_without_confirmation Can deliver from AnyAPM to the same APM without confirmation - yes / no
     *
     * @return self
     */
    public function setAnyApmToSameApmDeliveryWithoutConfirmation($any_apm_to_same_apm_delivery_without_confirmation)
    {
        if (is_null($any_apm_to_same_apm_delivery_without_confirmation)) {
            throw new \InvalidArgumentException('non-nullable any_apm_to_same_apm_delivery_without_confirmation cannot be null');
        }
        $this->container['any_apm_to_same_apm_delivery_without_confirmation'] = $any_apm_to_same_apm_delivery_without_confirmation;
    ...
    {
        return $this->container['custom_form'];
    }

    /**
     * Sets custom_form
     *
     * @param bool|null $custom_form Can use the Custom form in the Partner portal? yes / no - default no
     *
     * @return self
     */
    public function setCustomForm($custom_form)
    {
        if (is_null($custom_form)) {
            throw new \InvalidArgumentException('non-nullable custom_form cannot be null');
        }
        $this->container['custom_form'] = $custom_form;
    ...
    {
        return $this->container['cod_payment'];
    }

    /**
     * Sets cod_payment
     *
     * @param bool|null $cod_payment Can use COD payment mode? yes / no - default no
     *
     * @return self
     */
    public function setCodPayment($cod_payment)
    {
        if (is_null($cod_payment)) {
            throw new \InvalidArgumentException('non-nullable cod_payment cannot be null');
        }
        $this->container['cod_payment'] = $cod_payment;

        return $this;
    }

    /**
     * Gets can_customer_create_customer_returns
     *
     * @return bool|null
     */
    public function getCanCustomerCreateCustomerReturns()
    {
        return $this->container['can_customer_create_customer_returns'];
    }

    /**
     * Sets can_customer_create_customer_returns
     *
     * @param bool|null $can_customer_create_customer_returns Can customers create customer returns in the Customer portal? yes / no - default no
     *
     * @return self
     */
    public function setCanCustomerCreateCustomerReturns($can_customer_create_customer_returns)
    {
        if (is_null($can_customer_create_customer_returns)) {
            throw new \InvalidArgumentException('non-nullable can_customer_create_customer_returns cannot be null');
        }
        $this->container['can_customer_create_customer_returns'] = $can_customer_create_customer_returns;

        return $this;
    }

    /**
     * Gets can_partner_create_customer_returns
     *
     * @return bool|null
     */
    public function getCanPartnerCreateCustomerReturns()
    {
        return $this->container['can_partner_create_customer_returns'];
    }

    /**
     * Sets can_partner_create_customer_returns
     *
     * @param bool|null $can_partner_create_customer_returns Can create customer returns in the Partner portal? yes / no - default no
     *
     * @return self
     */
    public function setCanPartnerCreateCustomerReturns($can_partner_create_customer_returns)
    {
        if (is_null($can_partner_create_customer_returns)) {
            throw new \InvalidArgumentException('non-nullable can_partner_create_customer_returns cannot be null');
        }
        $this->container['can_partner_create_customer_returns'] = $can_partner_create_customer_returns;

        return $this;
    }

    /**
     * Gets address_as_destination
     *
     * @return bool|null
     */
    public function getAddressAsDestination()
    {
        return $this->container['address_as_destination'];
    }

    /**
     * Sets address_as_destination
     *
     * @param bool|null $address_as_destination Can create delivery to home address in the Partner portal? yes / no - default no
     *
     * @return self
     */
    public function setAddressAsDestination($address_as_destination)
    {
        if (is_null($address_as_destination)) {
            throw new \InvalidArgumentException('non-nullable address_as_destination cannot be null');
        }
        $this->container['address_as_destination'] = $address_as_destination;

        return $this;
    }

    /**
     * Gets cod_address_as_destination
     *
     * @return bool|null
     */
    public function getCodAddressAsDestination()
    {
        return $this->container['cod_address_as_destination'];
    }

    /**
     * Sets cod_address_as_destination
     *
     * @param bool|null $cod_address_as_destination Can use COD payment to create delivery to home address in the Partner portal? yes / no - default no
     *
     * @return self
     */
    public function setCodAddressAsDestination($cod_address_as_destination)
    {
        if (is_null($cod_address_as_destination)) {
            throw new \InvalidArgumentException('non-nullable cod_address_as_destination cannot be null');
        }
        $this->container['cod_address_as_destination'] = $cod_address_as_destination;

        return $this;
    }

    /**
     * Gets larger_compartment_while_sending
     *
     * @return bool|null
     */
    public function getLargerCompartmentWhileSending()
    {
        return $this->container['larger_compartment_while_sending'];
    }

    /**
     * Sets larger_compartment_while_sending
     *
     * @param bool|null $larger_compartment_while_sending Can request larger compartment while sending from APM? yes / no - default no
     *
     * @return self
     */
    public function setLargerCompartmentWhileSending($larger_compartment_while_sending)
    {
        if (is_null($larger_compartment_while_sending)) {
            throw new \InvalidArgumentException('non-nullable larger_compartment_while_sending cannot be null');
        }
        $this->container['larger_compartment_while_sending'] = $larger_compartment_while_sending;
