...
/**
 * PickupDeliveryPartnerInformation Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class PickupDeliveryPartnerInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PickupDeliveryPartnerInformation';
