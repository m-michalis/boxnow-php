...
class WebhookMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'datasignature' => 'setDatasignature',
        'data' => 'setData'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('datasignature', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['datasignature'] === null) {
            $invalidProperties[] = "'datasignature' can't be null";
        }
     ...
     * Sets subject
     *
     * @param string $subject Parcel ID
     *
     * @return self
     */
     ...
     *
     * @param string $datacontenttype Message content type
     *
     * @return self
     */
    ...
    {
        return $this->container['datasignature'];
    }

    /**
     * Sets datasignature
     *
     * @param string $datasignature HMAC SHA256 digest of data for receiver to verify integrity of received data
     *
     * @return self
     */
    public function setDatasignature($datasignature)
    {
        if (is_null($datasignature)) {
            throw new \InvalidArgumentException('non-nullable datasignature cannot be null');
        }
        $this->container['datasignature'] = $datasignature;
     ...
     * Gets data
     *
     * @return \Boxnow\Model\WebhookMessageData
     */
     ...
     * Sets data
     *
     * @param \Boxnow\Model\WebhookMessageData $data data
     *
     * @return self
     */
