...
/**
 * WebhookMessageDataCustomer Class Doc Comment
 *
 * @category Class
 * @description Customer information. Not specified for P2P parcels.
 * @package  Boxnow
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WebhookMessageDataCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookMessage_data_customer';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name, e.g. person or company name
     *
     * @return self
     */
