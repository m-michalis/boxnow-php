...
/**
 * WebhookMessageDataEventLocation Class Doc Comment
 *
 * @category Class
 * @package  Boxnow
 * @author   OpenAPI Generator team
 ...
 */
class WebhookMessageDataEventLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookMessage_data_eventLocation';
    ...
    */
     ...
     * Sets display_name
     *
     * @param string|null $display_name Name of the location where event happened
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Postal code of the location where event happened
     *
     * @return self
     */
